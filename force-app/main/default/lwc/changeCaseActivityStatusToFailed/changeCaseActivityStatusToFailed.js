...
export default class ChangeCaseActivityStatusToFailed extends LightningElement {
    @api recordId;
    ...
    updateCaseActivityRecord(attemptIntervalDays) {
        ...
        fields[STATUS_FIELD.fieldApiName] = 'Failed Contact';
    ...
    @api invoke() {
        ...
        if (caseActivityStatus != 'New') {
            this.showNotification(
                'It is not possible to mark as failed.',

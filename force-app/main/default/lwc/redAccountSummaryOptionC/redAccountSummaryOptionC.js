...
const SUBFEATURE = 'Red Account Summary Option C';

export default class RedAccountSummaryOptionC extends LightningElement {
    @api recordId;
    ...
    get previewText() {
        return this.bulletPoints.length ? this.bulletPoints[0] : 'Loading summary…';
    }

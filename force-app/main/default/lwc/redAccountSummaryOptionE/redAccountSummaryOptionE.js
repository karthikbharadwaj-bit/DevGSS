...
const SUBFEATURE = 'Red Account Summary Option E';

export default class RedAccountSummaryOptionE extends LightningElement {
    @api recordId;
    ...
    async fetchSummary() {
        try {
            ...
            if (parsed && parsed.success && parsed.summary) {
                ...
                const msg = (parsed && parsed.message) ? parsed.message : 'We\'re having trouble loading your summary data. Please try again later.';
                this.overallPoints = [msg];
                this.riskPoints = [];
                this.statusPoints = [];
            ...
            this.overallPoints = ['We\'re having trouble loading your summary data. Please try again later.'];
            this.riskPoints = [];
            this.statusPoints = [];
            this.nextStepsPoints = [];
            this.hasFetched = true;

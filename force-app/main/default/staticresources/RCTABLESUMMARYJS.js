/* RCTableSummary v1.0 (c) siva Nekkalapudi */
...
! function(e, t) {
    "object" === ("undefined" == typeof exports ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.RCTableSummary = t()
}(this, function() {
    "use strict";
    ...
    t.prototype.createHeadersElement = function() {
        ...
        return e.classList.add("RCtableSummary-headers"), e
    }, t.prototype.createHeaderElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtableSummary-header"), this.table.options.headerVisible || e.classList.add("RCtableSummary-header-hidden"), e
    ...
    o.prototype.getElement = function() {
        ...
        this._column.table.modExists("filter", !0) && this._column.table.modules.filter.getHeaderFilterValue(this._column)
    ...
    var i = function e(t, o) {
        ...
        this.table = o.table, this.definition = t, this.parent = o, this.type = "column", this.columns = [], this.cells = [], this.element = this.createElement(), this.contentElement = !1, this.titleElement = !1, this.groupElement = this.createGroupElement(), this.isGroup = !1, this.tooltip = !1, this.hozAlign = "", this.vertAlign = "", this.field = "", this.fieldStructure = "", this.getFieldValue = "", this.setFieldValue = "", this.titleFormatterRendered = !1, this.setField(this.definition.field), this.table.options.invalidOptionWarnings && this.checkDefinition(), this.modules = {}, this.cellEvents = {
            ...
            cellMouseOut: !1,
            cellMouseMove: !1
        }, this.width = null, this.widthStyled = "", this.minWidth = null, this.minWidthStyled = "", this.widthFixed = !1, this.visible = !0, this._mapDepricatedFunctionality(), t.columns ? (this.isGroup = !0, t.columns.forEach(function(t, o) {
            var n = new e(t, i);
            i.attachColumn(n)
    ...
    i.prototype.createElement = function() {
            var e = document.createElement("div");
            return e.classList.add("RCtableSummary-col"), e.setAttribute("role", "columnheader"), e.setAttribute("aria-sort", "none"), e
        }, i.prototype.createGroupElement = function() {
            var e = document.createElement("div");
            return e.classList.add("RCtableSummary-col-group-cols"), e
            ...
            t.field && this.element.setAttribute("RCtableSummary-field", t.field), e.setMinWidth(void 0 === t.minWidth ? e.table.options.columnMinWidth : parseInt(t.minWidth)), e.reinitializeWidth(), e.tooltip = e.definition.tooltip || !1 === e.definition.tooltip ? e.definition.tooltip : e.table.options.tooltips, e.hozAlign = void 0 === e.definition.hozAlign ? e.table.options.cellHozAlign : e.definition.hozAlign, e.vertAlign = void 0 === e.definition.vertAlign ? e.table.options.cellVertAlign : e.definition.vertAlign
        }, i.prototype._buildColumnHeaderContent = function() {
            var e = (self.definition, self.table, document.createElement("div"));
            return e.classList.add("RCtableSummary-col-content"), this.titleElement = this._buildColumnHeaderTitle(), e.appendChild(this.titleElement), e
        }, i.prototype._buildColumnHeaderTitle = function() {
            var e = this,
                t = e.definition,
                o = e.table,
                i = document.createElement("div");
            if (i.classList.add("RCtableSummary-col-title"), t.editableTitle) {
                var n = document.createElement("input");
                n.classList.add("RCtableSummary-title-editor"), n.addEventListener("click", function(e) {
            ...
            if (this.definition.titleFormatter && this.table.modExists("format")) switch (o = this.table.modules.format.getFormatter(this.definition.titleFormatter), r = function(e) {
            ...
            var e = this;
            if (this.element.classList.add("RCtableSummary-col-group"), this.element.setAttribute("role", "columngroup"), this.element.setAttribute("aria-title", this.definition.title), this.definition.cssClass) {
    ...
    n.prototype.createHolderElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtableSummary-tableHolder"), e.setAttribute("tabindex", 0), e
    }, n.prototype.createTableElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtableSummary-table"), e
        ...
        var n, s, a = e instanceof r ? e : new r(e || {}, this),
        ...
        var o = this.getDisplayRowIndex(e),
            i = !1;
        return o && (i = this.getDisplayRows()[o - 1]), !i || i instanceof r && "row" == i.type ? i : this.prevDisplayRow(i, t)
        ...
        if (this.redrawBlock) return void((!this.redrawBlockRestoreConfig || r.indexOf(e) < r.indexOf(this.redrawBlockRestoreConfig.stage)) && (this.redrawBlockRestoreConfig = {
            stage: e,
            skipStage: t,
            renderInPosition: o
        }));
        ...
        this.firstRender && (this.displayRowsCount ? (this.firstRender = !1, this.table.modules.layout.layout()) : this.renderEmptyScroll()), this.table.modExists("frozenColumns") && this.table.modules.frozenColumns.layout(), this.displayRowsCount || this.table.options.placeholder && (this.table.options.placeholder.setAttribute("RCtableSummary-render-mode", this.renderMode), this.getElement().appendChild(this.table.options.placeholder), this.table.options.placeholder.style.width = this.table.columnManager.getWidth() + "px"), this.table.options.renderComplete.call(this.table)
        ...
        var o = e.getElement();
        t % 2 ? (o.classList.add("RCtableSummary-row-even"), o.classList.remove("RCtableSummary-row-odd")) : (o.classList.add("RCtableSummary-row-odd"), o.classList.remove("RCtableSummary-row-even"))
    ...
    var r = function(e, t) {
        ...
        this.table = t.table, this.parent = t, this.data = {}, this.type = o, this.element = this.createElement(), this.modules = {}, this.cells = [], this.height = 0, this.heightStyled = "", this.manualHeight = !1, this.outerHeight = 0, this.initialized = !1, this.heightInitialized = !1, this.setData(e), this.generateElement()
    };
    r.prototype.createElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtableSummary-row"), e.setAttribute("role", "row"), e
        ...
        return new Promise(function(s, r) {
            ...
            i ? (o.normalizeHeight(), o.table.options.rowFormatter && o.table.options.rowFormatter(o.getComponent())) : (o.initialized = !1, o.height = 0, o.heightStyled = ""), !1 !== o.table.options.dataTree && o.table.modExists("dataTree") && o.table.modules.dataTree.redrawNeeded(e) && (o.table.modules.dataTree.initializeRow(o), o.table.modules.dataTree.layoutRow(o), o.table.rowManager.refreshActiveData("tree", !1, !0)), o.table.options.rowUpdated.call(o.table, o.getComponent()), s()
        })
    ...
    l.prototype.build = function() {
        ...
        this.element = document.createElement("div"), this.element.className = "RCtableSummary-cell", this.element.setAttribute("role", "gridcell"), this.element = this.element
        ...
        if (o.style.textAlign = e.column.hozAlign, e.column.vertAlign && (o.style.display = "inline-flex", o.style.alignItems = n[e.column.vertAlign] || "", e.column.hozAlign && (o.style.justifyContent = s[e.column.hozAlign] || "")), i && o.setAttribute("RCtableSummary-field", i), e.column.definition.cssClass) {
    ...
    c.prototype.createElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtableSummary-footer"), e
    ...
    u.prototype.defaultOptions = {
        ...
        return "undefined" != typeof HTMLElement && e instanceof HTMLElement ? (this.element = e, !0) : "string" == typeof e ? (this.element = document.querySelector(e), !!this.element || (console.error("RCTableSummary Creation Error - no element found matching selector: ", e), !1)) : (console.error("RCTableSummary Creation Error - Invalid element provided:", e), !1)
        ...
        this.element.classList.add("RCtableSummary-block-select"), window.getSelection ? window.getSelection().empty ? window.getSelection().empty() : window.getSelection().removeAllRanges && window.getSelection().removeAllRanges() : document.selection && document.selection.empty(), this.element.classList.remove("RCtableSummary-block-select")
        ...
        var e = this,
            ...
            o = this.modules,
            i = this.options;
        for (i.tableBuilding.call(this), t.classList.add("RCtableSummary"), t.setAttribute("role", "grid"); t.firstChild;) t.removeChild(t.firstChild);
        i.height && (i.height = isNaN(i.height) ? i.height : i.height + "px", t.style.height = i.height), !1 !== i.minHeight && (i.minHeight = isNaN(i.minHeight) ? i.minHeight : i.minHeight + "px", t.style.minHeight = i.minHeight), !1 !== i.maxHeight && (i.maxHeight = isNaN(i.maxHeight) ? i.maxHeight : i.maxHeight + "px", t.style.maxHeight = i.maxHeight),
            this.columnManager.initialize(), this.rowManager.initialize(), this._detectBrowser(), this.modExists("layout", !0) && o.layout.initialize(i.layout), !1 !== i.headerFilterPlaceholder && o.localize.setHeaderFilterPlaceholder(i.headerFilterPlaceholder);
        ...
        if (o.localize.setLocale(i.locale), "string" == typeof i.placeholder) {
            ...
            s.classList.add("RCtableSummary-placeholder");
        ...
        var e = this.element;
        for (u.prototype.comms.deregister(this), this.options.reactiveData && this.modExists("reactiveData", !0) && this.modules.reactiveData.unwatchData(), this.rowManager.rows.forEach(function(e) {
                e.wipe()
        ...
        e.classList.remove("RCtableSummary")
    ...
    }, u.prototype.moduleBindings = {}, u.prototype.extendModule = function(e, t, o) {
        ...
        return !!this.modules[e] || (t && console.error("RCTableSummary Module Not Installed: " + e), !1)
    }, u.prototype.helpers = {
        ...
        lookupTable: function(e, t) {
            ...
            } else "undefined" != typeof HTMLElement && e instanceof HTMLElement || e instanceof u ? (i = u.prototype.comms.matchElement(e)) && n.push(i) : Array.isArray(e) ? e.forEach(function(e) {
    ...
    d.prototype.initialize = function(e) {
        this.modes[e] ? this.mode = e : (console.warn("Layout Error - invalid mode set, defaulting to 'fitData' : " + e), this.mode = "fitData"), this.table.element.setAttribute("RCtableSummary-layout", this.mode)
    ...
    p.prototype.getConnections = function(e) {
        var t, o = this,
            i = [];
        return t = u.prototype.comms.lookupTable(e), t.forEach(function(e) {
            o.table !== e && i.push(e)
        }), i
    ...
    f.prototype.initialize = function() {
        ...
        var e = document.createElement("div");
        return e.classList.add("RCtableSummary-loader"), e
    }, f.prototype.createMsgElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtableSummary-loader-msg"), e.setAttribute("role", "alert"), e
        ...
        if ("function" == typeof this.table.options.ajaxLoader ? this.table.options.ajaxLoader() : this.table.options.ajaxLoader) {
            ...
            this.msgElement.classList.remove("RCtableSummary-error"), this.msgElement.classList.add("RCtableSummary-loading"), this.loadingElement ? this.msgElement.appendChild(this.loadingElement) : this.msgElement.innerHTML = this.table.modules.localize.getText("ajax|loading"), this.table.element.appendChild(this.loaderElement)
        }
    }, f.prototype.showError = function() {
        for (this.hideLoader(); this.msgElement.firstChild;) this.msgElement.removeChild(this.msgElement.firstChild);
        this.msgElement.classList.remove("RCtableSummary-loading"), this.msgElement.classList.add("RCtableSummary-error"), this.errorElement ? this.msgElement.appendChild(this.errorElement) : this.msgElement.innerHTML = this.table.modules.localize.getText("ajax|error"), this.table.element.appendChild(this.loaderElement)
    ...
    g.prototype.createElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtableSummary-calcs-holder"), e
    }, g.prototype.initialize = function() {
        this.genColumn = new i({
            field: "value"
        }, this)
    }, g.prototype.registerColumnField = function() {}, g.prototype.initializeColumn = function(e) {
        var t = e.definition,
            o = {
        ...
        return i.table.modExists("mutator") && i.table.modules.mutator.disable(), o = new r(n, this, "calc"), i.table.modExists("mutator") && i.table.modules.mutator.enable(), o.getElement().classList.add("RCtableSummary-calcs", "RCtableSummary-calcs-" + e), o.generateCells = function() {
            var t = [];
    ...
    b.prototype.initialize = function() {
        ...
        return Array.prototype.slice.call(i.getElementsByTagName("tr")).forEach(function(e) {
            var o = [],
                i = Array.prototype.slice.call(e.getElementsByTagName("th")),
                n = Array.prototype.slice.call(e.getElementsByTagName("td"));
            n = n.concat(i), n.forEach(function(e) {
                var t = e.innerHTML;
                t = "&nbsp;" == t ? "" : t, o.push(t)
            }), t.push(o.join("\t"))
        }), t.join("\n")
    ...
    v.prototype.initialize = function() {
        var e = null,
            ...
            o = this.table.options;
        switch (this.field = o.dataTreeChildField, this.indent = o.dataTreeChildIndent, this.elementField = o.dataTreeElementColumn || !!t && t.field, o.dataTreeBranchElement && (!0 === o.dataTreeBranchElement ? (this.branchEl = document.createElement("div"), this.branchEl.classList.add("RCtableSummary-data-tree-branch")) : "string" == typeof o.dataTreeBranchElement ? (e = document.createElement("div"), e.innerHTML = o.dataTreeBranchElement, this.branchEl = e.firstChild) : this.branchEl = o.dataTreeBranchElement), o.dataTreeCollapseElement ? "string" == typeof o.dataTreeCollapseElement ? (e = document.createElement("div"), e.innerHTML = o.dataTreeCollapseElement, this.collapseEl = e.firstChild) : this.collapseEl = o.dataTreeCollapseElement : (this.collapseEl = document.createElement("div"), this.collapseEl.classList.add("RCtableSummary-data-tree-control"), this.collapseEl.tabIndex = 0, this.collapseEl.innerHTML = "<div class='RCtableSummary-data-tree-control-collapse'></div>"), o.dataTreeExpandElement ? "string" == typeof o.dataTreeExpandElement ? (e = document.createElement("div"), e.innerHTML = o.dataTreeExpandElement, this.expandEl = e.firstChild) : this.expandEl = o.dataTreeExpandElement : (this.expandEl = document.createElement("div"), this.expandEl.classList.add("RCtableSummary-data-tree-control"), this.expandEl.tabIndex = 0, this.expandEl.innerHTML = "<div class='RCtableSummary-data-tree-control-expand'></div>"), _typeof(o.dataTreeStartExpanded)) {
            case "boolean":
        ...
        e.row.cells.indexOf(e) || !1 !== e.row.modules.dataTree.children && e.row.reinitialize()
    ...
    y.prototype.download = function(e, t, o, i, n) {
        ...
        var r = this,
            a = !1;
        this.processConfig(), this.active = i, "function" == typeof e ? a = e : r.downloaders[e] ? a = r.downloaders[e] : console.warn("Download Error - No such download type found: ", e), this.processColumns(), a && a.call(this, r.processDefinitions(), r.processData(i || "active"), o || {}, s, this.config)
        ...
        if (this.table.options.downloadConfig)
            for (var t in this.table.options.downloadConfig) e[t] = this.table.options.downloadConfig[t];
        this.config.rowGroups = e.rowGroups && this.table.options.groupBy && this.table.modExists("groupRows"), e.columnGroups && this.table.columnManager.columns.length != this.table.columnManager.columnsByIndex.length && (this.config.columnGroups = !0), e.columnCalcs && this.table.modExists("columnCalcs") && (this.config.columnCalcs = !0), e.dataTree && this.table.options.dataTree && this.table.modExists("dataTree") && (this.config.dataTree = !0)
    }, y.prototype.processColumns = function() {
        var e = this;
        e.columnsByIndex = [], e.columnsByField = {}, e.table.columnManager.columnsByIndex.forEach(function(t) {
        ...
        var e = this,
            t = [];
        return this.config.columnGroups ? e.table.columnManager.columns.forEach(function(o) {
        ...
        var t = this,
            ...
            s = !1,
            r = {};
        return this.config.rowGroups ? ("visible" == e ? (s = o.table.rowManager.getRows(e), s.forEach(function(e) {
            if ("row" == e.type) {
                var t = e.getGroup(); - 1 === n.indexOf(t) && n.push(t)
            }
        })) : n = this.table.modules.groupRows.getGroups(), n.forEach(function(e) {
            i.push(t.processGroupData(e, s))
        })) : (this.config.dataTree && (e = e = "display"), i = o.table.rowManager.getData(e, "download")), this.config.columnCalcs && (r = this.table.getCalcResults(), i = {
            calcs: r,
            data: i
        ...
        return i.length ? (n.subGroups = [], i.forEach(function(e) {
            n.subGroups.push(o.processGroupData(e, t))
        })) : t ? (n.rows = [], e.rows.forEach(function(e) {
            t.indexOf(e) > -1 && n.rows.push(e.getData("download"))
        })) : n.rows = e.getData(!0, "download"), n
    }, y.prototype.triggerDownload = function(e, t, o, i, n) {
        var s = document.createElement("a"),
            r = new Blob([e], {
                type: t
            }),
            i = i || "RCTableSummary." + ("function" == typeof o ? "txt" : o);
        ...
        csv: function(e, t, o, i, n) {
            ...
            n.columnGroups ? (console.warn("Download Warning - CSV downloader cannot process column groups"), e.forEach(function(e) {
                s(e, 0)
            })) : function() {
                e.forEach(function(e) {
                    d.push('"' + String(e.title).split('"').join('""') + '"'), h.push(e.field)
                })
            }(), l = [d.join(p)], n.columnCalcs && (console.warn("Download Warning - CSV downloader cannot process column calculations"), t = t.data), n.rowGroups ? (console.warn("Download Warning - CSV downloader cannot process row groups"), t.forEach(function(e) {
                a(e)
        ...
        pdf: function(e, t, o, i, n) {
            function s(e, t) {
                ...
                if (e.subGroups ? (e.subGroups.forEach(function(e) {
                        s(e, t + 1)
                    }), i = 1) : (h.push(e.definition.field), i = g - t), n.rowSpan = i, p[t].push(n), o--, i > 1)
            ...
            function c(e, t) {
                ...
                o.push({
                    ...
                    colSpan: h.length,
                    styles: v
                }), m.push(o), e.subGroups ? e.subGroups.forEach(function(o) {
            ...
            n.rowGroups ? t.forEach(function(e) {
                c(e, f)
            }) : (n.columnCalcs && u(f, "top"), a(t), n.columnCalcs && u(f, "bottom"));
            var x = new jsPDF(w);
            o && o.autoTable && (b = "function" == typeof o.autoTable ? o.autoTable(x) || {} : o.autoTable), E && (b.addPageContent = function(e) {
                x.text(E, 40, 30)
            }), b.head = p, b.body = m, x.autoTable(b), o && o.documentProcessing && o.documentProcessing(x), i(x.output("arraybuffer"), "application/pdf")
        },
        xlsx: function(e, t, o, i, n) {
            function s() {
                function o(e, t) {
                    void 0 === f[t] && (f[t] = []), void 0 === h[t] && (h[t] = []), e.width > 1 && h[t].push({
                        type: "hoz",
                        start: f[t].length,
                        end: f[t].length + e.width - 1
                    }), f[t].push(e.title), e.subGroups ? e.subGroups.forEach(function(e) {
                        o(e, t + 1)
                    }) : (g.push(e.definition.field), i(g.length), h[t].push({
                        type: "vert",
                        start: g.length - 1
                    }))
                }
                ...
                function m(e, t) {
                    var o = [];
                    o.push(e.key), d.push(b.length), b.push(o), e.subGroups ? e.subGroups.forEach(function(o) {
                ...
                var f = [],
                    g = [],
                    b = [];
                return n.columnGroups ? (e.forEach(function(e) {
                        o(e, 0)
    ...
    w.prototype.initializeColumn = function(e) {
        ...
        var e, t = this.currentCell;
        if (this.invalidEdit = !1, t) {
            for (this.currentCell = !1, e = t.getElement(), e.classList.remove("RCtableSummary-validation-fail"), e.classList.remove("RCtableSummary-editing"); e.firstChild;) e.removeChild(e.firstChild);
            t.row.getElement().classList.remove("RCtableSummary-row-editing")
        }
    }, w.prototype.cancelEdit = function() {
        if (this.currentCell) {
            var e = this.currentCell,
                t = this.currentCell.getComponent();
            this.clearEditor(), e.setValueActual(e.getValue()), e.cellRendered(), e.column.cellEvents.cellEditCancelled && e.column.cellEvents.cellEditCancelled.call(this.table, t), this.table.options.cellEditCancelled.call(this.table, t)
        }
    }, w.prototype.bindEditor = function(e) {
        var t = this,
            o = e.getElement();
        o.setAttribute("tabindex", 0), o.addEventListener("click", function(e) {
            o.classList.contains("RCtableSummary-editing") || o.focus({
                preventScroll: !0
            })
        ...
        function i(t) {
            if (c.currentCell === e) {
                var o = !0;
                return e.column.modules.validate && c.table.modExists("validate") && (o = c.table.modules.validate.validate(e.column.modules.validate, e.getComponent(), t)), !0 === o ? (c.clearEditor(), e.setValue(t, !0), c.table.options.dataTree && c.table.modExists("dataTree") && c.table.modules.dataTree.checkForRestyle(e), !0) : (c.invalidEdit = !0, h.classList.add("RCtableSummary-validation-fail"), c.focusCellNoEvent(e, !0), d(), c.table.options.validationFailed.call(c.table, e.getComponent(), t, o), !1)
            }
        }
        ...
        if (u || o) {
            if (c.cancelEdit(), c.currentCell = e, this.focusScrollAdjust(e), a = e.getComponent(), this.mouseClick && (this.mouseClick = !1, e.column.cellEvents.cellClick && e.column.cellEvents.cellClick.call(this.table, t, a)), e.column.cellEvents.cellEditing && e.column.cellEvents.cellEditing.call(this.table, a), c.table.options.cellEditing.call(this.table, a), l = "function" == typeof e.column.modules.edit.params ? e.column.modules.edit.params(a) : e.column.modules.edit.params, !1 === (r = e.column.modules.edit.editor.call(c, a, s, i, n, l))) return h.blur(), !1;
            ...
            for (h.classList.add("RCtableSummary-editing"), e.row.getElement().classList.add("RCtableSummary-row-editing"); h.firstChild;) h.removeChild(h.firstChild);
            h.appendChild(r), d();
        ...
        select: function(e, t, o, i, n) {
            function s(t) {
                var o, i = {},
                    s = f.table.getData();
                return o = t ? f.table.columnManager.getColumnByField(t) : e.getColumn()._getSelf(), o ? (s.forEach(function(e) {
            ...
            function r(t, o) {
                function i(e) {
                    var e = {
                        label: n.listItemFormatter ? n.listItemFormatter(e.value, e.label) : e.label,
                        value: e.value,
                        element: !1
                    };
                ...
                if ("function" == typeof t && (t = t(e)), Array.isArray(t)) t.forEach(function(e) {
                    ...
                    "object" === (void 0 === e ? "undefined" : _typeof(e)) ? e.options ? (t = {
                        ...
                        group: !0,
                        element: !1
                    }, r.push(t), e.options.forEach(function(e) {
                        i(e)
                    })) : i(e): (t = {
                        label: n.listItemFormatter ? n.listItemFormatter(e, e) : e,
                        value: e,
                        element: !1
                    }, t.value !== o && (isNaN(parseFloat(t.value)) || isNaN(parseFloat(t.value)) || parseFloat(t.value) !== parseFloat(o)) || l(t), s.push(t), r.push(t))
                });
                else
                    for (var c in t) {
                        var u = {
                            label: n.listItemFormatter ? n.listItemFormatter(c, t[c]) : t[c],
                            value: c,
                            element: !1
                        };
            ...
            function a() {
                ...
                x.forEach(function(e) {
                    var t = e.element;
                    t || (e.group ? (t = document.createElement("div"), t.classList.add("RCtableSummary-edit-select-list-group"), t.tabIndex = 0, t.innerHTML = "" === e.label ? "&nbsp;" : e.label) : (t = document.createElement("div"), t.classList.add("RCtableSummary-edit-select-list-item"), t.tabIndex = 0, t.innerHTML = "" === e.label ? "&nbsp;" : e.label, t.addEventListener("click", function() {
                        l(e), c()
                    }), e === R && t.classList.add("active")), t.addEventListener("mousedown", function() {
                        M = !1, setTimeout(function() {
                            M = !0
                        }, 10)
                    }), e.element = t), E.appendChild(t)
                })
            }
            ...
            function h() {
                if (!E.parentNode) {
                    ...
                    E.style.minWidth = g.offsetWidth + "px", E.style.top = e.top + g.offsetHeight + "px", E.style.left = e.left + "px", E.addEventListener("mousedown", function(e) {
                        M = !1, setTimeout(function() {
                            M = !0
                        }, 10)
            ...
            return w.value = void 0 !== b || null === b ? b : "", w.addEventListener("keydown", function(e) {
                var t;
                switch (e.keyCode) {
                    case 38:
                ...
                h()
            }), E = document.createElement("div"), E.classList.add("RCtableSummary-edit-select-list"), t(function() {
        ...
        autocomplete: function(e, t, o, i, n) {
            function s(t) {
                var o, i = {},
                    s = y.table.getData();
                return o = t ? y.table.columnManager.getColumnByField(t) : e.getColumn()._getSelf(), o ? (s.forEach(function(e) {
                    var t = o.getFieldValue(e);
                    null !== t && void 0 !== t && "" !== t && (i[t] = !0)
            ...
            function r(e, t) {
                var o, i, r = [];
                o = !0 === n.values ? s() : "string" == typeof n.values ? s(n.values) : n.values || [], n.searchFunc ? (r = n.searchFunc(e, o), r instanceof Promise ? (a(void 0 !== n.searchingPlaceholder ? n.searchingPlaceholder : "Searching..."), r.then(function(e) {
                    d(l(e), t)
                }).catch(function(e) {
                    console.err("error in autocomplete search promise:", e)
                })) : d(l(r), t)) : (i = l(o), "" === e ? n.showListOnEmpty && (r = i) : i.forEach(function(t) {
            ...
            function a(e) {
                ...
                c(), !1 !== e && (t.classList.add("RCtableSummary-edit-select-list-notice"), t.tabIndex = 0, e instanceof Node ? t.appendChild(e) : t.innerHTML = e, M.appendChild(t))
            }
            ...
            function l(e) {
                ...
                if (Array.isArray(e)) e.forEach(function(e) {
                    var o = {
                        title: n.listItemFormatter ? n.listItemFormatter(e, e) : e,
                        value: e
                    };
                    t.push(o)
                });
            ...
            function h(e, t) {
                var o = !1;
                c(), L = e, L.forEach(function(e) {
                    var i = e.element;
                    i || (i = document.createElement("div"), i.classList.add("RCtableSummary-edit-select-list-item"), i.tabIndex = 0, i.innerHTML = e.title, i.addEventListener("click", function(t) {
                        f(e), p()
                    }), i.addEventListener("mousedown", function(e) {
                        D = !1, setTimeout(function() {
                            D = !0
                        }, 10)
                    }), e.element = i, t && e.value == E && (R.value = e.title, e.element.classList.add("active"), o = !0), e === T && (e.element.classList.add("active"), o = !0)), M.appendChild(i)
                }), o || f(!1)
            }
            ...
            var y = this,
                ...
                T = !1,
                D = !0;
            if (this.table.rowManager.element.addEventListener("scroll", b), R.setAttribute("type", "search"), R.style.padding = "4px", R.style.width = "100%", R.style.boxSizing = "border-box", n.elementAttributes && "object" == _typeof(n.elementAttributes))
            ...
            return M.classList.add("RCtableSummary-edit-select-list"), M.addEventListener("mousedown", function(e) {
                D = !1, setTimeout(function() {
                    D = !0
                }, 10)
        ...
        progress: function(e, t, o, i, n) {
            ...
            var r, a, l = e.getElement(),
                ...
                p = document.createElement("div"),
                m = document.createElement("div");
            if (p.style.position = "absolute", p.style.right = "0", p.style.top = "0", p.style.bottom = "0", p.style.width = "5px", p.classList.add("RCtableSummary-progress-handle"), m.style.display = "inline-block", m.style.position = "relative", m.style.height = "100%", m.style.backgroundColor = "#488CE9", m.style.maxWidth = "100%", m.style.minWidth = "0%", n.elementAttributes && "object" == _typeof(n.elementAttributes))
    ...
    E.prototype.genereateTable = function(e, t, o, i) {
        ...
        return n.classList.add("RCtableSummary-print-table"), !1 !== this.config.columnHeaders && n.appendChild(this.generateHeaderElements()), n.appendChild(this.generateBodyElements(this.rowLookup(o))),
            this.mapElementStyles(this.table.element, n, ["border-top", "border-left", "border-right", "border-bottom"]), n
        ...
        if ("function" == typeof e) e.call(this.table).forEach(function(e) {
            ...
            case "all":
                ...
                break;
            case "selected":
                o = this.modules.selectRow.selectedRows;
                break;
            case "active":
            default:
        ...
        function t(e, n) {
            var s = i - n;
            void 0 === o[n] && (o[n] = []), e.height = e.subGroups ? 1 : s - e.depth + 1, o[n].push(e), e.subGroups && e.subGroups.forEach(function(e) {
                t(e, n + 1)
            })
        }
        var o = [],
        ...
        return this.groupHeadersToRows(this.generateColumnGroupHeaders()).forEach(function(o) {
            ...
            e.mapElementStyles(e.table.columnManager.getHeadersElement(), t, ["border-top", "border-left", "border-right", "border-bottom", "background-color", "color", "font-weight", "font-family", "font-size"]), o.forEach(function(t) {
                var o = document.createElement("th"),
                    n = t.column.definition.cssClass ? t.column.definition.cssClass.split(" ") : [];
                o.colSpan = t.width, o.rowSpan = t.height, o.innerHTML = t.column.definition.title, e.cloneTableStyle && (o.style.boxSizing = "border-box"), n.forEach(function(e) {
                    o.classList.add(e)
                }), e.mapElementStyles(t.column.getElement(), o, ["text-align", "border-top", "border-left", "border-right", "border-bottom", "background-color", "color", "font-weight", "font-family", "font-size"]), e.mapElementStyles(t.column.contentElement, o, ["padding-top", "padding-left", "padding-right", "padding-bottom"]), t.column.visible ? e.mapElementStyles(t.column.getElement(), o, ["width"]) : t.column.definition.width && (o.style.width = t.column.definition.width + "px"), t.column.parent && e.mapElementStyles(t.column.parent.groupElement, o, ["border-top"]), i.appendChild(o)
            }), t.appendChild(i)
        }), t
    }, E.prototype.generateBodyElements = function(e) {}, E.prototype.generateBodyElements = function(e) {
        var t, o, i, n, s, r, a, l, c, u, d = this;
        u = this.table.options["rowFormatter" + (this.colVisProp.charAt(0).toUpperCase() + this.colVisProp.slice(1))], u = null !== u ? u : this.table.options.rowFormatter, this.cloneTableStyle && window.getComputedStyle && (t = this.table.element.querySelector(".RCtableSummary-row-odd:not(.RCtableSummary-group):not(.RCtableSummary-calcs)"), o = this.table.element.querySelector(".RCtableSummary-row-even:not(.RCtableSummary-group):not(.RCtableSummary-calcs)"), i = this.table.element.querySelector(".RCtableSummary-row.RCtableSummary-calcs"), n = this.table.element.querySelector(".RCtableSummary-row:not(.RCtableSummary-group):not(.RCtableSummary-calcs)"), r = this.table.element.getElementsByClassName("RCtableSummary-group")[0], n && (a = n.getElementsByClassName("RCtableSummary-cell"), s = a[0], a[a.length - 1]));
        var h = document.createElement("tbody"),
            p = [];
        return !1 !== this.config.columnCalcs && this.table.modExists("columnCalcs") && (this.table.modules.columnCalcs.topInitialized && e.unshift(this.table.modules.columnCalcs.topRow), this.table.modules.columnCalcs.botInitialized && e.push(this.table.modules.columnCalcs.botRow)), this.table.columnManager.columnsByIndex.forEach(function(e) {
            d.columnVisCheck(e) && p.push(e)
        }), this.table.options.dataTree && !1 !== this.config.dataTree && this.table.modExists("columnCalcs") && (c = this.table.modules.dataTree.elementField), e = e.filter(function(e) {
            switch (e.type) {
                case "group":
            ...
            return !0
        }), e.length > 1e3 && console.warn("It may take a long time to render an HTML table with more than 1000 rows"), e.forEach(function(e, n) {
            var a = e.getData(d.colVisProp),
                m = document.createElement("tr");
            switch (m.classList.add("RCtableSummary-print-table-row"), e.type) {
                case "group":
                    var f = document.createElement("td");
                    f.colSpan = p.length, f.innerHTML = e.key, m.classList.add("RCtableSummary-print-table-group"), d.mapElementStyles(r, m, ["border-top", "border-left", "border-right", "border-bottom", "color", "font-weight", "font-family", "font-size", "background-color"]), d.mapElementStyles(r, f, ["padding-top", "padding-left", "padding-right", "padding-bottom"]), m.appendChild(f);
                    break;
                case "calc":
                    m.classList.add("RCtableSummary-print-table-calcs");
                case "row":
                    if (d.table.options.dataTree && !1 === d.config.dataTree && e.modules.dataTree.parent) return;
                    if (p.forEach(function(t, o) {
                            ...
                            if ((t.definition.cssClass ? t.definition.cssClass.split(" ") : []).forEach(function(e) {
                                    i.classList.add(e)
                                }), d.table.modExists("format") && !1 !== d.config.formatCells) n = d.table.modules.format.formatExportValue(r, d.colVisProp);
                            else switch (void 0 === n ? "undefined" : _typeof(n)) {
                                case "object":
                                    n = JSON.stringify(n);
                                    break;
                                case "undefined":
                            ...
                            n instanceof Node ? i.appendChild(n) : i.innerHTML = n, s && (d.mapElementStyles(s, i, ["padding-top", "padding-left", "padding-right", "padding-bottom", "border-top", "border-left", "border-right", "border-bottom", "color", "font-weight", "font-family", "font-size"]), t.definition.align && (i.style.textAlign = t.definition.align)), d.table.options.dataTree && !1 !== d.config.dataTree && (c && c == t.field || !c && 0 == o) && (e.modules.dataTree.controlEl && i.insertBefore(e.modules.dataTree.controlEl.cloneNode(!0), i.firstChild), e.modules.dataTree.branchEl && i.insertBefore(e.modules.dataTree.branchEl.cloneNode(!0), i.firstChild)), m.appendChild(i), r.modules.format && r.modules.format.renderedCallback && r.modules.format.renderedCallback()
                        }), l = "calc" == e.type ? i : n % 2 && o ? o : t, d.mapElementStyles(l, m, ["border-top", "border-left", "border-right", "border-bottom", "color", "font-weight", "font-family", "font-size", "background-color"]), u && !1 !== d.config.formatCells) {
    ...
    C.prototype.initializeColumn = function(e, t) {
        function o(t) {
            var o, s = "input" == e.modules.filter.tagType && "text" == e.modules.filter.attrType || "textarea" == e.modules.filter.tagType ? "partial" : "match",
                r = "",
                a = "";
            if (void 0 === e.modules.filter.prevSuccess || e.modules.filter.prevSuccess !== t) {
                if (e.modules.filter.prevSuccess = t, e.modules.filter.emptyFunc(t)) delete i.headerFilters[n];
                    ...
                    switch (e.modules.filter.value = t, _typeof(e.definition.headerFilterFunc)) {
                        case "string":
                            i.filters[e.definition.headerFilterFunc] ? (r = e.definition.headerFilterFunc, o = function(o) {
        ...
        if (e.modules.filter.headerElement && e.modules.filter.headerElement.parentNode && e.contentElement.removeChild(e.modules.filter.headerElement.parentNode), m) {
            switch (e.modules.filter.emptyFunc = e.definition.headerFilterEmptyCheck || function(e) {
                return !e && "0" !== e
            }, n = document.createElement("div"), n.classList.add("RCtableSummary-header-filter"), _typeof(e.definition.headerFilter)) {
                case "string":
            ...
            if (s) {
                if (a = {
                    ...
                    }, u = e.definition.headerFilterParams || {}, u = "function" == typeof u ? u.call(h.table) : u, !(r = s.call(this.table.modules.edit, a, function() {}, p, i, u))) return void console.warn("Filter Error - Cannot add filter to " + m + " column, editor returned a value of false");
        ...
        var i = this;
        i.filterList = [], Array.isArray(e) || (e = [{
            field: e,
            type: t,
            value: o
        }]), i.addFilter(e)
    ...
    x.prototype.initializeColumn = function(e) {
        ...
        money: function(e, t, o) {
            var i, n, s, r, a = parseFloat(e.getValue()),
                l = t.decimal || ".",
                c = t.thousand || ",",
                u = t.symbol || "",
                d = !!t.symbolAfter,
        ...
        link: function(e, t, o) {
            ...
            if (t.labelField && (i = e.getData(), a = i[t.labelField]), t.label) switch (_typeof(t.label)) {
                case "string":
                    a = t.label;
                    break;
                case "function":
        ...
        traffic: function(e, t, o) {
            ...
            if (!isNaN(s) && void 0 !== e.getValue()) {
                switch (r.classList.add("RCtableSummary-traffic-light"), n = parseFloat(s) <= a ? parseFloat(s) : a, n = parseFloat(n) >= l ? parseFloat(n) : l, i = (a - l) / 100, n = Math.round((n - l) / i), void 0 === c ? "undefined" : _typeof(c)) {
                    case "string":
                        u = c;
                        break;
                    case "function":
        ...
        progress: function(e, t, o) {
            var i, n, s, r, l, c = this.sanitizeHTML(e.getValue()) || 0,
                u = e.getElement(),
                d = t && t.max ? t.max : 100,
                h = t && t.min ? t.min : 0,
        ...
        handle: function(e, t, o) {
            return e.getElement().classList.add("RCtableSummary-row-handle"), "<div class='RCtableSummary-row-handle-box'><div class='RCtableSummary-row-handle-bar'></div><div class='RCtableSummary-row-handle-bar'></div><div class='RCtableSummary-row-handle-bar'></div></div>"
        },
        responsiveCollapse: function(e, t, o) {
            ...
            return n.classList.add("RCtableSummary-responsive-collapse-toggle"), n.innerHTML = "<span class='RCtableSummary-responsive-collapse-toggle-open'>+</span><span class='RCtableSummary-responsive-collapse-toggle-close'>-</span>", e.getElement().classList.add("RCtableSummary-row-handle"), n.addEventListener("click", function(e) {
    ...
    R.prototype.reset = function() {
        ...
        this.leftColumns.forEach(function(i, n) {
            if (i.modules.frozen.margin = t._calcSpace(t.leftColumns, n) + t.table.columnManager.scrollLeft + "px", n == t.leftColumns.length - 1 ? i.modules.frozen.edge = !0 : i.modules.frozen.edge = !1, i.parent.isGroup) {
                ...
                o.includes(s) || (t.layoutElement(s, i), o.push(s)), i.modules.frozen.edge && s.classList.add("RCtableSummary-frozen-" + i.modules.frozen.position)
        ...
        t.modules.frozen && (e.style.position = "absolute", e.style.left = t.modules.frozen.margin, e.classList.add("RCtableSummary-frozen"), t.modules.frozen.edge && e.classList.add("RCtableSummary-frozen-" + t.modules.frozen.position))
    ...
    M.prototype.initialize = function() {
        this.rows = [], this.topElement.classList.add("RCtableSummary-frozen-rows-holder"), this.table.columnManager.getElement().insertBefore(this.topElement, this.table.columnManager.headersElement.nextSibling)
    ...
    var T = function(e, t, o, i, n, s, r) {
        this.groupManager = e, this.parent = t, this.key = i, this.level = o, this.field = n, this.hasSubGroups = o < e.groupIDLookups.length - 1, this.addRow = this.hasSubGroups ? this._addRowToGroup : this._addRow, this.type = "group", this.old = r, this.rows = [], this.groups = [], this.groupList = [], this.generator = s, this.elementContents = !1, this.height = 0, this.outerHeight = 0, this.initialized = !1, this.calcs = {}, this.initialized = !1, this.modules = {}, this.arrowElement = !1, this.visible = r ? r.visible : void 0 !== e.startOpen[o] ? e.startOpen[o] : e.startOpen[0], this.createElements(), this.addBindings(), this.createValueGroups()
    };
    T.prototype.wipe = function() {
        ...
        var e = document.createElement("div");
        e.classList.add("RCtableSummary-arrow"), this.element = document.createElement("div"), this.element.classList.add("RCtableSummary-row"), this.element.classList.add("RCtableSummary-group"), this.element.classList.add("RCtableSummary-group-level-" + this.level), this.element.setAttribute("role", "rowgroup"), this.arrowElement = document.createElement("div"), this.arrowElement.classList.add("RCtableSummary-group-toggle"), this.arrowElement.appendChild(e), !1 !== this.groupManager.table.options.movableRows && this.groupManager.table.modExists("moveRow") && this.groupManager.table.modules.moveRow.initializeGroupHeader(this)
        ...
        }), n.groupManager.table.options.groupTap && (o = !1, n.element.addEventListener("touchstart", function(e) {
            o = !0
        }, {
            passive: !0
    ...
    }, T.prototype.getRowIndex = function(e) {}, T.prototype.conformRowData = function(e) {
        ...
        this.visible = !1, "classic" != this.groupManager.table.rowManager.getRenderMode() || this.groupManager.table.options.pagination ? this.groupManager.updateGroupRows(!0) : (this.element.classList.remove("RCtableSummary-group-visible"), this.groupList.length ? this.groupList.forEach(function(e) {
        ...
        if (e.visible = !0, "classic" != this.groupManager.table.rowManager.getRenderMode() || this.groupManager.table.options.pagination) this.groupManager.updateGroupRows(!0);
            ...
            this.element.classList.add("RCtableSummary-group-visible");
            var t = e.getElement();
            this.groupList.length ? this.groupList.forEach(function(e) {
                e.getHeadersAndRows().forEach(function(e) {
                    var o = e.getElement();
        ...
        this.addBindingsd = !1, this._visSet(), this.visible ? this.element.classList.add("RCtableSummary-group-visible") : this.element.classList.remove("RCtableSummary-group-visible");
        ...
        return this
    }, T.prototype.reinitializeHeight = function() {}, T.prototype.calcHeight = function() {}, T.prototype.setCellHeight = function() {}, T.prototype.clearCellHeight = function() {}, T.prototype.getComponent = function() {
        return new L(this)
    };
    var D = function(e) {
    ...
    S.prototype.parseTable = function() {
        ...
        for (var r in i) {
            var a, l = i[r];
            l && "object" == (void 0 === l ? "undefined" : _typeof(l)) && l.name && 0 === l.name.indexOf("RCtableSummary-") && (a = l.name.replace("RCtableSummary-", ""), void 0 !== s[a] && (t[s[a]] = this._attribValue(l.value)))
        }
        ...
        for (var o = 0; o < e.length; o++) {
            ...
            }, a.field || (a.field = s.textContent.trim().toLowerCase().replace(" ", "_")), n = s.getAttribute("width"), n && !a.width && (a.width = n), s.attributes, this._extractOptions(s, a, i.prototype.defaultOptionList), this.fieldIndex[o] = a.field, a.field == this.table.options.index && (this.hasIndex = !0), r || this.table.options.columns.push(a)
        }
    ...
    z.prototype.initialize = function() {
        ...
        navNext: function(e) {
            ...
            this.table.modExists("edit") && (o = this.table.modules.edit.currentCell) && (e.preventDefault(), t = o.nav(), t.next() || i && (o.getElement().firstChild.blur(), i = !0 === i ? this.table.addRow({}) : "function" == typeof i ? this.table.addRow(i(o.row.getComponent())) : this.table.addRow(i), i.then(function() {
                setTimeout(function() {
                    t.next()
                })
            })))
    ...
    H.prototype.initializeColumnHeader = function(e) {
        ...
        e.definition.headerContextMenu && e.getElement().addEventListener("contextmenu", function(t) {
            var i = "function" == typeof e.definition.headerContextMenu ? e.definition.headerContextMenu() : e.definition.headerContextMenu;
            t.preventDefault(), o.loadMenu(t, e, i)
        }), e.definition.headerMenu && (t = document.createElement("span"), t.classList.add("RCtableSummary-header-menu-button"), t.innerHTML = "&vellip;", t.addEventListener("click", function(t) {
            var i = "function" == typeof e.definition.headerMenu ? e.definition.headerMenu() : e.definition.headerMenu;
        ...
        e.getElement().addEventListener("contextmenu", function(o) {
            var i = "function" == typeof e.column.definition.contextMenu ? e.column.definition.contextMenu() : e.column.definition.contextMenu;
            o.preventDefault(), t.loadMenu(o, e, i)
        })
    }, H.prototype.initializeRow = function(e) {
        var t = this;
        e.getElement().addEventListener("contextmenu", function(o) {
            var i = "function" == typeof t.table.options.rowContextMenu ? t.table.options.rowContextMenu() : t.table.options.rowContextMenu;
            o.preventDefault(), t.loadMenu(o, e, i)
        })
    }, H.prototype.loadMenu = function(e, t, o) {
        var i = this,
            n = Math.max(document.body.offsetHeight, window.innerHeight);
        o && o.length && (this.hideMenu(), this.menuEl = document.createElement("div"), this.menuEl.classList.add("RCtableSummary-menu"), o.forEach(function(e) {
            var o = document.createElement("div"),
                n = e.label,
                s = e.disabled;
            e.separator ? o.classList.add("RCtableSummary-menu-separator") : (o.classList.add("RCtableSummary-menu-item"), "function" == typeof n && (n = n(t.getComponent())), n instanceof Node ? o.appendChild(n) : o.innerHTML = n, "function" == typeof s && (s = s(t.getComponent())), s ? (o.classList.add("RCtableSummary-menu-item-disabled"), o.addEventListener("click", function(e) {
                e.stopPropagation()
        ...
        }, 100), document.body.appendChild(this.menuEl), e.pageX + this.menuEl.offsetWidth >= document.body.offsetWidth && (this.menuEl.style.left = "", this.menuEl.style.right = document.body.offsetWidth - e.pageX + "px"), e.pageY + this.menuEl.offsetHeight >= n && (this.menuEl.style.top = "", this.menuEl.style.bottom = n - e.pageY + "px"))
    }, H.prototype.hideMenu = function() {
        this.menuEl.parentNode && this.menuEl.parentNode.removeChild(this.menuEl), this.blurEvent && (document.body.removeEventListener("click", this.blurEvent), document.body.removeEventListener("contextmenu", this.blurEvent), this.table.rowManager.element.removeEventListener("scroll", this.blurEvent))
    }, H.prototype.menus = {}, u.prototype.registerModule("menu", H);
    var F = function(e) {
    ...
    F.prototype.createPlaceholderElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtableSummary-col"), e.classList.add("RCtableSummary-col-placeholder"), e
    }, F.prototype.initializeColumn = function(e) {
        var t, o = this,
            i = {};
        e.modules.frozen || (t = e.getElement(), i.mousemove = function(i) {
            e.parent === o.moving.parent && ((o.touchMove ? i.touches[0].pageX : i.pageX) - u.prototype.helpers.elOffset(t).left + o.table.columnManager.element.scrollLeft > e.getWidth() / 2 ? o.toCol === e && o.toColAfter || (t.parentNode.insertBefore(o.placeholderElement, t.nextSibling), o.moveColumn(e, !0)) : (o.toCol !== e || o.toColAfter) && (t.parentNode.insertBefore(o.placeholderElement, t), o.moveColumn(e, !1)))
        ...
        var o = t.getElement();
        this.moving = t, this.startX = (this.touchMove ? e.touches[0].pageX : e.pageX) - u.prototype.helpers.elOffset(o).left, this.table.element.classList.add("RCtableSummary-block-select"), this.placeholderElement.style.width = t.getWidth() + "px", this.placeholderElement.style.height = t.getHeight() + "px", o.parentNode.insertBefore(this.placeholderElement, o), o.parentNode.removeChild(o), this.hoverElement = o.cloneNode(!0), this.hoverElement.classList.add("RCtableSummary-moving"), this.table.columnManager.getElement().appendChild(this.hoverElement), this.hoverElement.style.left = "0", this.hoverElement.style.bottom = "0", this.touchMove || (this._bindMouseMove(), document.body.addEventListener("mousemove", this.moveHover), document.body.addEventListener("mouseup", this.endMove)), this.moveHover(e)
    ...
    A.prototype.createPlaceholderElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtableSummary-row"), e.classList.add("RCtableSummary-row-placeholder"), e
        ...
        var o = t.getElement();
        this.setStartPosition(e, t), this.moving = t, this.table.element.classList.add("RCtableSummary-block-select"), this.placeholderElement.style.width = t.getWidth() + "px", this.placeholderElement.style.height = t.getHeight() + "px", this.connection ? (this.table.element.classList.add("RCtableSummary-movingrow-sending"), this.connectToTables(t)) : (o.parentNode.insertBefore(this.placeholderElement, o), o.parentNode.removeChild(o)), this.hoverElement = o.cloneNode(!0), this.hoverElement.classList.add("RCtableSummary-moving"), this.connection ? (document.body.appendChild(this.hoverElement), this.hoverElement.style.left = "0", this.hoverElement.style.top = "0", this.hoverElement.style.width = this.table.element.clientWidth + "px", this.hoverElement.style.whiteSpace = "nowrap", this.hoverElement.style.overflow = "hidden", this.hoverElement.style.pointerEvents = "none") : (this.table.rowManager.getTableElement().appendChild(this.hoverElement), this.hoverElement.style.left = "0", this.hoverElement.style.top = "0", this._bindMouseMove()), document.body.addEventListener("mousemove", this.moveHover), document.body.addEventListener("mouseup", this.endMove), this.moveHover(e)
        ...
        e && 1 !== e.which && !this.touchMove || (this._unbindMouseMove(), this.connection || (this.placeholderElement.parentNode.insertBefore(this.moving.getElement(), this.placeholderElement.nextSibling), this.placeholderElement.parentNode.removeChild(this.placeholderElement)), this.hoverElement.parentNode.removeChild(this.hoverElement), this.table.element.classList.remove("RCtableSummary-block-select"), this.toRow && this.table.rowManager.moveRow(this.moving, this.toRow, this.toRowAfter), this.moving = !1, this.toRow = !1, this.toRowAfter = !1, document.body.removeEventListener("mousemove", this.moveHover), document.body.removeEventListener("mouseup", this.endMove), this.connection && (this.table.element.classList.remove("RCtableSummary-movingrow-sending"), this.disconnectFromTables()))
        ...
        this.table.options.movableRowsSendingStart.call(this.table, t), this.table.modules.comms.send(this.connection, "moveRow", "connect", {
            row: e
        })
        ...
        var o = this;
        return this.connectedTable ? (console.warn("Move Row Error - Table cannot accept connection, already connected to table:", this.connectedTable), !1) : (this.connectedTable = e, this.connectedRow = t, this.table.element.classList.add("RCtableSummary-movingrow-receiving"), o.table.rowManager.getDisplayRows().forEach(function(e) {
        ...
        var t = this;
        e === this.connectedTable ? (this.connectedTable = !1, this.connectedRow = !1, this.table.element.classList.remove("RCtableSummary-movingrow-receiving"), t.table.rowManager.getDisplayRows().forEach(function(e) {
    ...
    P.prototype.initializeColumn = function(e) {
        ...
        this.enabled = !1
    }, P.prototype.mutators = {}, u.prototype.registerModule("mutator", P);
    var _ = function(e) {
    ...
    _.prototype.createElements = function() {
        var e;
        this.element = document.createElement("span"), this.element.classList.add("RCtableSummary-paginator"), this.pagesElement = document.createElement("span"), this.pagesElement.classList.add("RCtableSummary-pages"), e = document.createElement("button"), e.classList.add("RCtableSummary-page"), e.setAttribute("type", "button"), e.setAttribute("role", "button"), e.setAttribute("aria-label", ""), e.setAttribute("title", ""), this.firstBut = e.cloneNode(!0), this.firstBut.setAttribute("data-page", "first"), this.prevBut = e.cloneNode(!0), this.prevBut.setAttribute("data-page", "prev"), this.nextBut = e.cloneNode(!0), this.nextBut.setAttribute("data-page", "next"), this.lastBut = e.cloneNode(!0), this.lastBut.setAttribute("data-page", "last"), this.table.options.paginationSizeSelector && (this.pageSizeSelect = document.createElement("select"), this.pageSizeSelect.classList.add("RCtableSummary-page-size"))
        ...
        e = parseInt(e), e > 0 && (this.size = e), this.pageSizeSelect && this.generatePageSizeSelectList(), this.table.options.persistence && this.table.modExists("persistence", !0) && this.table.modules.persistence.config.page && this.table.modules.persistence.save("page")
        ...
        return o.classList.add("RCtableSummary-page"), e == t.page && o.classList.add("active"), o.setAttribute("type", "button"), o.setAttribute("role", "button"), o.setAttribute("aria-label", "Show Page " + e), o.setAttribute("title", "Show Page " + e), o.setAttribute("data-page", e), o.textContent = e, o.addEventListener("click", function(o) {
            t.setPage(e)
        }), o
        ...
        var e, t, o = this,
            i = this;
        return new Promise(function(n, s) {
            if (i.table.modExists("ajax", !0) || s(), e = u.prototype.helpers.deepClone(i.table.modules.ajax.getParams() || {}), t = i.table.modules.ajax.getParams(), t[o.dataSentNames.page] = i.page, o.size && (t[o.dataSentNames.size] = o.size), o.table.options.ajaxSorting && o.table.modExists("sort")) {
    ...
    }, _.prototype.paginationDataSentNames = {
        page: "page",
        size: "size",
        sorters: "sorters",
        filters: "filters"
    }, _.prototype.paginationDataReceivedNames = {
    ...
    B.prototype.initialize = function() {
        ...
        this.manualBlock || (this.element = document.createElement("div"), this.element.classList.add("RCtableSummary-print-table"), this.element.appendChild(this.table.modules.export.genereateTable(this.table.options.printConfig, this.table.options.printStyled, this.table.options.printRowRange, "print")), this.table.element.style.display = "none", this.table.element.parentNode.insertBefore(this.element, this.table.element))
    }, B.prototype.cleanup = function() {
        document.body.classList.remove("RCtableSummary-print-fullscreen-hide"), this.element && this.element.parentNode && (this.element.parentNode.removeChild(this.element), this.table.element.style.display = "")
        ...
        this.manualBlock = !0, this.element = document.createElement("div"), this.element.classList.add("RCtableSummary-print-fullscreen"), this.table.options.printHeader && (a.classList.add("RCtableSummary-print-header"), i = "function" == typeof this.table.options.printHeader ? this.table.options.printHeader.call(this.table) : this.table.options.printHeader, "string" == typeof i ? a.innerHTML = i : a.appendChild(i), this.element.appendChild(a)), this.element.appendChild(c), this.table.options.printFooter && (l.classList.add("RCtableSummary-print-footer"), n = "function" == typeof this.table.options.printFooter ? this.table.options.printFooter.call(this.table) : this.table.options.printFooter, "string" == typeof n ? l.innerHTML = n : l.appendChild(n), this.element.appendChild(l)), document.body.classList.add("RCtableSummary-print-fullscreen-hide"), document.body.appendChild(this.element), this.table.options.printFormatter && this.table.options.printFormatter(this.element, c), window.print(), this.cleanup(), window.scrollTo(s, r), this.manualBlock = !1
    ...
    O.prototype.initializeColumn = function(e, t, o) {
        ...
        if ("header" === e && (n = "textarea" == t.definition.formatter || t.definition.variableHeight, t.modules.resize = {
            ...
            r.className = "RCtableSummary-col-resize-handle";
            var a = document.createElement("div");
            a.className = "RCtableSummary-col-resize-handle prev", r.addEventListener("click", function(e) {
                e.stopPropagation()
            });
            var l = function(e) {
    ...
    j.prototype.initializeRow = function(e) {
        var t = this,
            o = e.getElement(),
            i = document.createElement("div");
        i.className = "RCtableSummary-row-resize-handle";
        var n = document.createElement("div");
        n.className = "RCtableSummary-row-resize-handle prev", i.addEventListener("click", function(e) {
            e.stopPropagation()
        });
        var s = function(o) {
        ...
        function n(e) {
            document.body.removeEventListener("mouseup", i), document.body.removeEventListener("mousemove", i), o.removeEventListener("touchmove", i), o.removeEventListener("touchend", n), s.table.element.classList.remove("RCtableSummary-block-select"), s.table.options.rowResized.call(this.table, t.getComponent())
        }
        var s = this;
        s.table.element.classList.add("RCtableSummary-block-select"), e.stopPropagation(), s.startY = void 0 === e.screenY ? e.touches[0].screenY : e.screenY, s.startHeight = t.getHeight(), document.body.addEventListener("mousemove", i), document.body.addEventListener("mouseup", n), o.addEventListener("touchmove", i, {
            passive: !0
        }), o.addEventListener("touchend", n)
    ...
    G.prototype.initialize = function() {
        ...
        var t;
        "calc" !== e.type && (t = document.createElement("div"), t.classList.add("RCtableSummary-responsive-collapse"), e.modules.responsiveLayout = {
            element: t,
    ...
    W.prototype.clearSelectionData = function(e) {
        ...
        e.modules.select = {
            selected: !1
        }, t.table.options.selectableCheck.call(this.table, e.getComponent()) ? (o.classList.add("RCtableSummary-selectable"), o.classList.remove("RCtableSummary-unselectable"), t.table.options.selectable && "highlight" != t.table.options.selectable && ("click" === t.table.options.selectableRangeMode ? o.addEventListener("click", function(o) {
            if (o.shiftKey) {
        ...
        })))) : (o.classList.add("RCtableSummary-unselectable"), o.classList.remove("RCtableSummary-selectable"))
        ...
        n ? (o = i.selectedRows.findIndex(function(e) {
            return e == n
        })) > -1 && (n.modules.select || (n.modules.select = {}), n.modules.select.selected = !1, n.modules.select.checkboxEl && (n.modules.select.checkboxEl.checked = !1), n.getElement().classList.remove("RCtableSummary-selected"), i.selectedRows.splice(o, 1), this.table.options.dataTreeSelectPropagate && this.childRowSelection(n, !1), t || i.table.options.rowDeselected.call(this.table, n.getComponent()), i._rowSelectionChanged(t)) : t || console.warn("Deselection Error - No such row found, ignoring selection:" + e)
    ...
    U.prototype.initializeColumn = function(e, t) {
        ...
        }, (void 0 === e.definition.headerSort ? !1 !== this.table.options.headerSort : !1 !== e.definition.headerSort) && (o = e.getElement(), o.classList.add("RCtableSummary-sortable"), i = document.createElement("div"), i.classList.add("RCtableSummary-arrow"), t.appendChild(i), o.addEventListener("click", function(t) {
            var o = "",
                i = [],
                s = !1;
            if (e.modules.sort) {
        ...
        }), i.length && t._sortItems(e, i)), t.table.options.dataSorted && t.table.options.dataSorted.call(t.table, t.getSort(), t.table.rowManager.getComponents("active"))
    ...
    return Y.prototype.initializeColumn = function(e) {
        var t, o = this,
            i = [];
        ...
        return e && e.forEach(function(e) {
            e.func.call(i, t, o, e.params) || n.push({
                type: e.type,
                parameters: e.params
            })
        }), !n.length || n
    ...
    }, u.prototype.registerModule("validate", Y), u
});

/* Ring Central v1.0 (c) Siva Nekkalapudi*/
...
! function(e, t) {
    "object" === ("undefined" == typeof exports ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.RCTable = t()
}(this, function() {
    "use strict";
    ...
    t.prototype.createHeadersElement = function() {
        ...
        return e.classList.add("RCtable-headers"), e
    }, t.prototype.createHeaderElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtable-header"), this.table.options.headerVisible || e.classList.add("RCtable-header-hidden"), e
        ...
        o.columns = [], o.columnsByIndex = [], o.columnsByField = {}, o.table.modExists("frozenColumns") && o.table.modules.frozenColumns.reset(), e.forEach(function(e, t) {
            o._addColumn(e)
        }), o._reIndexColumns(), o.table.options.responsiveLayout && o.table.modExists("responsiveLayout", !0) && o.table.modules.responsiveLayout.initialize(), this.table.options.virtualDomHoz && this.table.vdomHoz.reinitialize(!1, !0), o.redraw(!0)
        ...
        var s, a = this,
            r = e.indexOf(t),
            l = [];
        r > -1 && (e.splice(r, 1), s = e.indexOf(o), s > -1 ? i && (s += 1) : s = r, e.splice(s, 0, t), n && (this.table.options.dataTree && this.table.modExists("dataTree", !0) && this.table.rowManager.rows.forEach(function(e) {
            l = l.concat(a.table.modules.dataTree.getTreeChildren(e, !1, !0))
        }), l = l.concat(this.table.rowManager.rows), l.forEach(function(e) {
            if (e.cells.length) {
        ...
        var t, o = e.getField();
        o && delete this.columnsByField[o], t = this.columnsByIndex.indexOf(e), t > -1 && this.columnsByIndex.splice(t, 1), t = this.columns.indexOf(e), t > -1 && this.columns.splice(t, 1), this.table.options.responsiveLayout && this.table.modExists("responsiveLayout", !0) && this.table.modules.responsiveLayout.initialize(), this._verticalAlignHeaders(), this.redraw()
    }, t.prototype.redraw = function(e) {
        e && (h.prototype.helpers.elVisible(this.element) && this._verticalAlignHeaders(), this.table.rowManager.resetScroll(), this.table.rowManager.reinitialize()), ["fitColumns", "fitDataStretch"].indexOf(this.table.modules.layout.getMode()) > -1 ? this.table.modules.layout.layout() : e ? this.table.modules.layout.layout() : this.table.options.responsiveLayout && this.table.modExists("responsiveLayout", !0) && this.table.modules.responsiveLayout.update(), this.table.modExists("frozenColumns") && this.table.modules.frozenColumns.layout(), this.table.modExists("columnCalcs") && this.table.modules.columnCalcs.recalc(this.table.rowManager.activeRows), e && (this.table.options.persistence && this.table.modExists("persistence", !0) && this.table.modules.persistence.config.columns && this.table.modules.persistence.save("columns"), this.table.modExists("columnCalcs") && this.table.modules.columnCalcs.redraw()), this.table.footerManager.redraw()
    };
    var o = function(e) {
    ...
    o.prototype.getElement = function() {
        ...
        var t;
        return t = !0 === e ? this._column.reinitializeWidth(!0) : this._column.setWidth(e), this._column.table.options.virtualDomHoz && this._column.table.vdomHoz.reinitialize(!0), t
    }, o.prototype.validate = function() {
        return this._column.validate()
    };
    var n = function e(t, o) {
        var i = this;
        this.table = o.table, this.definition = t, this.parent = o, this.type = "column", this.columns = [], this.cells = [], this.element = this.createElement(), this.contentElement = !1, this.titleHolderElement = !1, this.titleElement = !1, this.groupElement = this.createGroupElement(), this.isGroup = !1, this.tooltip = !1, this.hozAlign = "", this.vertAlign = "", this.field = "", this.fieldStructure = "", this.getFieldValue = "", this.setFieldValue = "", this.titleFormatterRendered = !1, this.setField(this.definition.field), this.table.options.invalidOptionWarnings && this.checkDefinition(), this.modules = {}, this.cellEvents = {
            cellClick: !1,
            cellDblClick: !1,
            cellContext: !1,
            cellTap: !1,
            ...
            cellMouseOut: !1,
            cellMouseMove: !1
        }, this.width = null, this.widthStyled = "", this.maxWidth = null, this.maxWidthStyled = "", this.minWidth = null, this.minWidthStyled = "", this.widthFixed = !1, this.visible = !0, this.component = null, this._mapDepricatedFunctionality(), t.columns ? (this.isGroup = !0, t.columns.forEach(function(t, o) {
            var n = new e(t, i);
            i.attachColumn(n)
    ...
    n.prototype.createElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtable-col"), e.setAttribute("role", "columnheader"), e.setAttribute("aria-sort", "none"), e
    }, n.prototype.createGroupElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtable-col-group-cols"), e
        ...
        var e = this;
        if (this.element.classList.add("RCtable-col-group"), this.element.setAttribute("role", "columngroup"), this.element.setAttribute("aria-title", this.definition.title), this.definition.cssClass) {
            this.definition.cssClass.split(" ").forEach(function(t) {
                e.element.classList.add(t)
            })
        }(this.definition.headerContextMenu || this.definition.headerMenu) && this.table.modExists("menu") && this.table.modules.menu.initializeColumnHeader(this), this.titleElement.style.textAlign = this.definition.headerHozAlign || this.table.options.headerHozAlign, this.element.appendChild(this.groupElement)
        ...
        this.visible && (this.visible = !1, this.element.style.display = "none", this.table.columnManager._verticalAlignHeaders(), this.parent.isGroup && this.parent.checkColumnVisibility(), this.cells.forEach(function(e) {
            e.hide()
        }), this.table.options.persistence && this.table.modExists("persistence", !0) && this.table.modules.persistence.config.columns && this.table.modules.persistence.save("columns"), !t && this.table.options.responsiveLayout && this.table.modExists("responsiveLayout", !0) && this.table.modules.responsiveLayout.updateColumnVisibility(this, this.visible), e || this.table.options.columnVisibilityChanged.call(this.table, this.getComponent(), !1), this.parent.isGroup && this.parent.matchChildWidths(), !this.silent && this.table.options.virtualDomHoz && this.table.vdomHoz.reinitialize())
        ...
        return new Promise(function(t, o) {
            ...
            e.element.parentNode && e.element.parentNode.removeChild(e.element), e.element = !1, e.contentElement = !1, e.titleElement = !1, e.groupElement = !1, e.parent.isGroup && e.parent.removeChild(e), e.table.columnManager.deregisterColumn(e), e.table.options.virtualDomHoz && e.table.vdomHoz.reinitialize(!0), t()
        })
        ...
        this.widthFixed = !1, void 0 === this.definition.width || e || this.setWidth(this.definition.width), this.table.modExists("filter") && this.table.modules.filter.hideHeaderFilterElements(), this.fitToData(), this.table.modExists("filter") && this.table.modules.filter.showHeaderFilterElements()
    ...
    s.prototype.createHolderElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtable-tableHolder"), e.setAttribute("tabindex", 0), e
    }, s.prototype.createTableElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtable-table"), e
        ...
        return new Promise(function(e, l) {
            if (s > -1) {
                if (void 0 === t && (t = n.table.options.scrollToRowPosition), void 0 === o && (o = n.table.options.scrollToRowIfVisible), "nearest" === t) switch (n.renderMode) {
                    case "classic":
                        i = h.prototype.helpers.elOffset(a).top, t = Math.abs(n.element.scrollTop - i) > Math.abs(n.element.scrollTop + n.element.clientHeight - i) ? "bottom" : "top";
                        break;
                    case "virtual":
        ...
        this.rows.forEach(function(e) {
            e.wipe()
        }), this.table.options.groupBy && this.table.modExists("groupRows") && this.table.modules.groupRows.wipe(), this.rows = [], this.activeRows = [], this.activeRowsCount = 0, this.displayRows = [], this.displayRowsCount = 0, this.adjustTableSize()
        ...
        i > -1 && this.activeRows.splice(i, 1), o > -1 && this.rows.splice(o, 1), this.setActiveRows(this.activeRows), this.displayRowIterator(function(t) {
            var o = t.indexOf(e);
            o > -1 && t.splice(o, 1)
        }), t || this.reRenderInPosition(), this.regenerateRowNumbers(), this.table.options.rowDeleted.call(this.table, e.getComponent()), this.table.options.dataChanged && this.table.options.dataChanged.call(this.table, this.getData()), this.table.options.groupBy && this.table.modExists("groupRows") ? this.table.modules.groupRows.updateGroupRows(!0) : this.table.options.pagination && this.table.modExists("page") ? this.refreshActiveData(!1, !1, !0) : this.table.options.pagination && this.table.modExists("page") && this.refreshActiveData("page")
        ...
        var n, s, a = e instanceof l ? e : new l(e || {}, this),
        ...
        }), n > -1 && this.activeRows.splice(r ? n : n + 1, 0, a), this.rows.splice(r ? c : c + 1, 0, a)) : r ? (this.displayRowIterator(function(e) {
            e.unshift(a)
        }), this.activeRows.unshift(a), this.rows.unshift(a)) : (this.displayRowIterator(function(e) {
            e.push(a)
        }), this.activeRows.push(a), this.rows.push(a)), this.setActiveRows(this.activeRows), this.table.options.rowAdded.call(this.table, a.getComponent()), this.table.options.dataChanged && this.table.options.dataChanged.call(this.table, this.getData()), i || this.reRenderInPosition(), a
        ...
        var o = this.getDisplayRowIndex(e),
            i = !1;
        return !1 !== o && o < this.displayRowsCount - 1 && (i = this.getDisplayRows()[o + 1]), !i || i instanceof l && "row" == i.type ? i : this.nextDisplayRow(i, t)
    }, s.prototype.prevDisplayRow = function(e, t) {
        var o = this.getDisplayRowIndex(e),
            i = !1;
        return o && (i = this.getDisplayRows()[o - 1]), !t || !i || i instanceof l && "row" == i.type ? i : this.prevDisplayRow(i, t)
        ...
        h.prototype.helpers.elVisible(n.element) && (o ? n.reRenderInPosition() : ("all" === e && this.table.options.virtualDomHoz && this.table.vdomHoz.dataChange(), n.renderTable(), s.options.layoutColumnsOnNewData && n.table.columnManager.redraw(!0))), s.modExists("columnCalcs") && s.modules.columnCalcs.recalc(this.activeRows)
        ...
        this.firstRender && (this.displayRowsCount ? (this.firstRender = !1, this.table.modules.layout.layout()) : this.renderEmptyScroll()), this.table.modExists("frozenColumns") && this.table.modules.frozenColumns.layout(), this.displayRowsCount || this.table.options.placeholder && (this.table.options.placeholder.setAttribute("RCtable-render-mode", this.renderMode), this.getElement().appendChild(this.table.options.placeholder), this.table.options.placeholder.style.width = this.table.columnManager.getWidth() + "px"), this.table.options.renderComplete.call(this.table)
        ...
        var o = e.getElement();
        t % 2 ? (o.classList.add("RCtable-row-even"), o.classList.remove("RCtable-row-odd")) : (o.classList.add("RCtable-row-odd"), o.classList.remove("RCtable-row-even"))
        ...
        if (i.displayRowsCount && h.prototype.helpers.elVisible(i.element)) {
            for (i.vDomTop = e, i.vDomBottom = e - 1;
    ...
    var a = function(e) {
        this.table = e, this.element = this.table.rowManager.tableElement, this.holderEl = this.table.rowManager.element, this.leftCol = 0, this.rightCol = 0, this.scrollLeft = 0, this.vDomScrollPosLeft = 0, this.vDomScrollPosRight = 0, this.vDomPadLeft = 0, this.vDomPadRight = 0, this.fitDataColAvg = 0, this.window = 200, this.initialized = !1, this.columns = [], this.compatabilityCheck() && this.initialize()
    };
    a.prototype.compatabilityCheck = function() {
        var e = this.table.options,
            t = !0;
        return "fitDataTable" == e.layout && (console.warn("Horizontal Vitrual DOM is not compatible with fitDataTable layout mode"), t = !1), e.responsiveLayout && (console.warn("Horizontal Vitrual DOM is not compatible with responsive columns"), t = !1), this.table.rtl && (console.warn("Horizontal Vitrual DOM is not currently compatible with RTL text direction"), t = !1), e.columns && e.columns.find(function(e) {
            return e.frozen
        }) && (console.warn("Horizontal Vitrual DOM is not compatible with frozen columns"), t = !1), t || (e.virtualDomHoz = !1), t
    }, a.prototype.initialize = function() {
        var e = this;
        this.holderEl.addEventListener("scroll", function() {
            var t = e.holderEl.scrollLeft;
            e.scrollLeft != t && (e.scrollLeft = t, e.scroll(t - (e.vDomScrollPosLeft + e.window)))
        })
        ...
        if ("fitData" === this.table.options.layout) {
            if (this.table.columnManager.columnsByIndex.forEach(function(e) {
                ...
                }), i && i && this.table.rowManager.getDisplayRows().length && (this.vDomScrollPosRight = this.scrollLeft + this.holderEl.clientWidth + this.window, this.table.options.groupBy ? (e = this.table.modules.groupRows.getGroups(!1)[0], t = e.getRows(!1)[0]) : t = this.table.rowManager.getDisplayRows()[0], t)) {
                o = t.getElement(), t.generateCells(), this.element.appendChild(o);
                for (var s = 0; s < t.cells.length; s++) {
                    var a = t.cells[s];
                    if (o.appendChild(a.getElement()), a.column.reinitializeWidth(), (n += a.column.getWidth()) > this.vDomScrollPosRight) break
                }
        ...
        if (!e || this.initialized) {
            ...
            this.table.columnManager.columnsByIndex.forEach(function(e) {
                ...
                if (e.visible) {
                    var i = e.getWidth();
                    t.leftPos = n, t.rightPos = n + i, n + i > o.vDomScrollPosLeft && n < o.vDomScrollPosRight ? (-1 == o.leftCol && (o.leftCol = o.columns.length, o.vDomPadLeft = n), o.rightCol = o.columns.length) : -1 !== o.leftCol && (o.vDomPadRight += i), o.columns.push(e), e.modules.vdomHoz = t, n += i
                }
            }), this.element.style.paddingLeft = this.vDomPadLeft + "px", this.element.style.paddingRight = this.vDomPadRight + "px", this.initialized = !0, t || e && !this.reinitChanged(i) || this.renitializeRows(), this.holderEl.scrollLeft = this.scrollLeft
        }
        ...
        this.vDomScrollPosLeft += e, this.vDomScrollPosRight += e, e > .8 * this.holderEl.clientWidth ? this.reinitialize() : e > 0 ? (this.addColRight(), this.removeColLeft()) : (this.addColLeft(), this.removeColRight())
        ...
        i && i.modules.vdomHoz.leftPos <= this.vDomScrollPosRight && (e = this.table.rowManager.getVisibleRows(), e.forEach(function(e) {
            if ("group" !== e.type) {
                var t = e.getCell(i);
        ...
        if (e && e.modules.vdomHoz.rightPos >= this.vDomScrollPosLeft) {
            ...
            }), this.leftCol ? this.vDomPadLeft -= e.getWidth() : this.vDomPadLeft = 0, this.element.style.paddingLeft = this.vDomPadLeft + "px", this.leftCol--, this.addColLeft()
        }
    }, a.prototype.removeColRight = function(e) {
        var t, e = this.columns[this.rightCol];
        e && e.modules.vdomHoz.leftPos > this.vDomScrollPosRight && (t = this.table.rowManager.getVisibleRows(), e.modules.vdomHoz.visible = !1, t.forEach(function(t) {
            if ("group" !== t.type) {
                var o = t.getCell(e);
                t.getElement().removeChild(o.getElement())
            }
        }), this.vDomPadRight += e.getWidth(), this.element.style.paddingRight = this.vDomPadRight + "px", this.rightCol--, this.removeColRight())
    }, a.prototype.removeColLeft = function() {
        var e, t = this.columns[this.leftCol];
        t && t.modules.vdomHoz.rightPos < this.vDomScrollPosLeft && (e = this.table.rowManager.getVisibleRows(), e.forEach(function(e) {
            if ("group" !== e.type) {
                var o = e.getCell(t);
                e.getElement().removeChild(o.getElement())
            }
        }), this.vDomPadLeft += t.getWidth(), this.element.style.paddingLeft = this.vDomPadLeft + "px", this.leftCol++, this.removeColLeft())
    ...
    var l = function(e, t) {
        ...
        this.table = t.table, this.parent = t, this.data = {}, this.type = o, this.element = !1, this.modules = {}, this.cells = [], this.height = 0, this.heightStyled = "", this.manualHeight = !1, this.outerHeight = 0, this.initialized = !1, this.heightInitialized = !1, this.component = null, this.created = !1, this.setData(e)
    };
    l.prototype.create = function() {
        this.created || (this.created = !0, this.generateElement())
    }, l.prototype.createElement = function() {
        var e = document.createElement("div");
        e.classList.add("RCtable-row"), e.setAttribute("role", "row"), this.element = e
        ...
        if (this.create(), !this.initialized || e) {
            ...
            this.table.modExists("frozenColumns") && this.table.modules.frozenColumns.layoutRow(this), this.generateCells(), this.table.options.virtualDomHoz && this.table.vdomHoz.initialized ? this.table.vdomHoz.initializeRow(this) : this.cells.forEach(function(e) {
                t.element.appendChild(e.getElement()), e.cellRendered()
            }), e && this.normalizeHeight(), this.table.options.dataTree && this.table.modExists("dataTree") && this.table.modules.dataTree.layoutRow(this), "collapse" === this.table.options.responsiveLayout && this.table.modExists("responsiveLayout") && this.table.modules.responsiveLayout.layoutRow(this), this.table.options.rowFormatter && this.table.options.rowFormatter(this.getComponent()), this.table.options.resizableRows && this.table.modExists("resizeRows") && this.table.modules.resizeRows.initializeRow(this), this.initialized = !0
        ...
        this.initialized = !1, this.heightInitialized = !1, this.manualHeight || (this.height = 0, this.heightStyled = ""), this.element && null !== this.element.offsetParent && this.initialize(!0), this.table.options.dataTree && this.table.modExists("dataTree", !0) && this.table.modules.dataTree.getTreeChildren(this, !1, !0).forEach(function(e) {
            e.reinitialize(!0)
        })
        ...
        return new Promise(function(s, a) {
            ...
            o.table.options.groupUpdateOnCellEdit && o.table.options.groupBy && o.table.modExists("groupRows") && o.table.modules.groupRows.reassignRowToGroup(o.row), i ? (o.normalizeHeight(!0), o.table.options.rowFormatter && o.table.options.rowFormatter(o.getComponent())) : (o.initialized = !1, o.height = 0, o.heightStyled = ""), !1 !== o.table.options.dataTree && o.table.modExists("dataTree") && o.table.modules.dataTree.redrawNeeded(e) && (o.table.modules.dataTree.initializeRow(o), i && (o.table.modules.dataTree.layoutRow(o), o.table.rowManager.refreshActiveData("tree", !1, !0))), o.table.options.rowUpdated.call(o.table, o.getComponent()), o.table.options.dataChanged && o.table.options.dataChanged.call(o.table, o.table.rowManager.getData()), s()
        })
        ...
        if (e > 0)
            for (var o = e - 1; o >= 0; o--) {
                var i = this.cells[o],
                    n = !0;
                if (i.column.modules.edit && h.prototype.helpers.elVisible(i.getElement()) && ("function" == typeof i.column.modules.edit.check && (n = i.column.modules.edit.check(i.getComponent())), n)) {
                    t = i;
                    break
                }
            }
    ...
    var u = function(e, t) {
        this.table = e.table, this.column = e, this.row = t, this.element = null, this.value = null, this.initialValue, this.oldValue = null, this.modules = {}, this.height = null, this.width = null, this.minWidth = null, this.component = null, this.loaded = !1, this.build()
    };
    u.prototype.build = function() {
        ...
        this.element = document.createElement("div"), this.element.className = "RCtable-cell", this.element.setAttribute("role", "gridcell"), this.element = this.element
        ...
        if (o.style.textAlign = e.column.hozAlign, e.column.vertAlign && (o.style.display = "inline-flex", o.style.alignItems = n[e.column.vertAlign] || "", e.column.hozAlign && (o.style.justifyContent = s[e.column.hozAlign] || "")), i && o.setAttribute("RCtable-field", i), e.column.definition.cssClass) {
        ...
        this.oldValue = this.value, this.value = e, this.table.options.reactiveData && this.table.modExists("reactiveData") && this.table.modules.reactiveData.block(), this.column.setFieldValue(this.row.data, e), this.table.options.reactiveData && this.table.modExists("reactiveData") && this.table.modules.reactiveData.unblock(), this.loaded && this.layoutElement()
    }, u.prototype.layoutElement = function() {
        this._generateContents(), this._generateTooltip(), this.table.options.resizableColumns && this.table.modExists("resizeColumns") && "row" === this.row.type && this.table.modules.resizeColumns.initializeColumn("cell", this.column, this.element), (this.column.definition.contextMenu || this.column.definition.clickMenu) && this.table.modExists("menu") && this.table.modules.menu.initializeCell(this), this.table.modExists("frozenColumns") && this.table.modules.frozenColumns.layoutElement(this.element, this.column)
        ...
        !this.table.rowManager.redrawBlock && this.element.parentNode && this.element.parentNode.removeChild(this.element), this.modules.validate && this.modules.validate.invalid && this.table.modules.validate.clearValidation(this), this.modules.edit && this.modules.edit.edited && this.table.modules.edit.clearEdited(this), this.table.options.history && this.table.modules.history.clearComponentHistory(this), this.element = !1, this.column.deleteCell(this), this.row.deleteCell(this), this.calcs = {}
    ...
    d.prototype.createElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtable-footer"), e
    ...
    var h = function e(t, o) {
        this.options = {}, this.columnManager = null, this.rowManager = null, this.footerManager = null, this.vdomHoz = null, this.browser = "", this.browserSlow = !1, this.browserMobile = !1, this.rtl = !1, this.modules = {}, this.initializeElement(t) && (this.initializeOptions(o || {}), this._create()), e.prototype.comms.register(this)
    };
    h.prototype.defaultOptions = {
        ...
        headerSortElement: "<div class='RCtable-arrow'></div>",
        footerElement: !1,
        index: "id",
        textDirection: "auto",
        keybindings: [],
        ...
        if (!1 !== e.invalidOptionWarnings)
            for (var t in e) void 0 === this.defaultOptions[t] && console.warn("Invalid table constructor option:", t);
        for (var t in this.defaultOptions) t in e ? this.options[t] = e[t] : Array.isArray(this.defaultOptions[t]) ? this.options[t] = Object.assign([], this.defaultOptions[t]) : "object" === _typeof(this.defaultOptions[t]) && null !== this.defaultOptions[t] ? this.options[t] = Object.assign({}, this.defaultOptions[t]) : this.options[t] = this.defaultOptions[t]
    }, h.prototype.initializeElement = function(e) {
        return "undefined" != typeof HTMLElement && e instanceof HTMLElement ? (this.element = e, !0) : "string" == typeof e ? (this.element = document.querySelector(e), !!this.element || (console.error("RCTable Creation Error - no element found matching selector: ", e), !1)) : (console.error("RCTable Creation Error - Invalid element provided:", e), !1)
        ...
        switch (this.options.textDirection) {
            ...
            case "rtl":
                this.element.classList.add("RCtable-rtl"), this.rtl = !0;
                break;
            case "ltr":
                this.element.classList.add("RCtable-ltr");
            default:
                this.rtl = !1
        }
        ...
        this.element.classList.add("RCtable-block-select"), window.getSelection ? window.getSelection().empty ? window.getSelection().empty() : window.getSelection().removeAllRanges && window.getSelection().removeAllRanges() : document.selection && document.selection.empty(), this.element.classList.remove("RCtable-block-select")
    }, h.prototype._create = function() {
        this._clearObjectPointers(), this._mapDepricatedFunctionality(), this.bindModules(), this.rtlCheck(), "TABLE" === this.element.tagName && this.modExists("htmlTableImport", !0) && this.modules.htmlTableImport.parseTable(), this.columnManager = new t(this), this.rowManager = new s(this), this.footerManager = new d(this), this.columnManager.setRowManager(this.rowManager), this.rowManager.setColumnManager(this.columnManager), this.options.virtualDomHoz && (this.vdomHoz = new a(this)), this._buildElement(), this._loadInitialData()
        ...
        var e = this,
            ...
            o = this.modules,
            i = this.options;
        for (i.tableBuilding.call(this), t.classList.add("RCtable"), t.setAttribute("role", "grid"); t.firstChild;) t.removeChild(t.firstChild);
        ...
        if (o.localize.setLocale(i.locale), "string" == typeof i.placeholder) {
            ...
            s.classList.add("RCtable-placeholder");
        ...
        if (e.options.pagination && e.modExists("page"))
            if (e.modules.page.reset(!0, !0), "local" == e.options.pagination) {
                ...
                e.options.paginationInitialPage && e.modules.page.setPage(e.options.paginationInitialPage)
            } else e.options.ajaxURL ? e.modules.page.setPage(e.options.paginationInitialPage).then(function() {}).catch(function() {}) : e.rowManager.setData([], !1, !0);
        else e.options.data.length ? e.rowManager.setData(e.options.data) : (e.options.ajaxURL || e.options.ajaxURLGenerator) && e.modExists("ajax") ? e.modules.ajax.loadData(!1, !0).then(function() {}).catch(function() {}) : e.rowManager.setData(e.options.data, !1, !0)
    }, h.prototype.destroy = function() {
        var e = this.element;
        for (h.prototype.comms.deregister(this), this.options.reactiveData && this.modExists("reactiveData", !0) && this.modules.reactiveData.unwatchData(), this.rowManager.rows.forEach(function(e) {
                e.wipe()
        ...
        if (!this.modExists("groupRows", !0)) return !1;
        this.options.groupValues = e, this.modules.groupRows.initialize(), this.rowManager.refreshActiveData("display"), this.options.persistence && this.modExists("persistence", !0) && this.modules.persistence.config.group && this.modules.persistence.save("group")
        ...
        this.modules = {};
        for (var e in h.prototype.moduleBindings) this.modules[e] = new h.prototype.moduleBindings[e](this)
    }, h.prototype.modExists = function(e, t) {
        return !!this.modules[e] || (t && console.error("RCTable Module Not Installed: " + e), !1)
    }, h.prototype.helpers = {
        ...
        deepClone: function(e) {
            ...
            for (var o in e) null != e[o] && "object" === _typeof(e[o]) && (e[o] instanceof Date ? t[o] = new Date(e[o]) : t[o] = this.deepClone(e[o]));
            return t
        }
    }, h.prototype.comms = {
        tables: [],
    ...
    p.prototype.initialize = function(e) {
        this.modes[e] ? this.mode = e : (console.warn("Layout Error - invalid mode set, defaulting to 'fitData' : " + e), this.mode = "fitData"), this.table.element.setAttribute("RCtable-layout", this.mode)
        ...
        fitColumns: function(e) {
            ...
            function o(e, i, n, s) {
                ...
                return e.forEach(function(e, t) {
                    var o = s ? l(e) : a(e);
                    e.column.minWidth >= o ? c.push(e) : e.column.maxWidth && e.column.maxWidth < o ? (e.width = e.column.maxWidth, i -= e.column.maxWidth, (p -= s ? e.column.definition.widthShrink || 1 : e.column.definition.widthGrow || 1) && (n = Math.floor(i / p))) : (g.push(e), f += s ? e.column.definition.widthShrink || 1 : e.column.definition.widthGrow || 1)
                }), c.length ? (c.forEach(function(e) {
                    u += s ? e.width - e.column.minWidth : e.column.minWidth, e.width = e.column.minWidth
                }), d = i - u, h = f ? Math.floor(d / f) : d, m = d - h * f, m += o(g, d, h, s)) : (m = f ? i - Math.floor(i / f) * f : i, g.forEach(function(e) {
                    e.width = s ? l(e) : a(e)
                })), m
            }
            var i = this,
    ...
    var m = function(e) {
        this.table = e, this.locale = "default", this.lang = !1, this.bindings = {}, this.langList = {}
    };
    m.prototype.initialize = function() {
        ...
        var o = this;
        if (e = e || "default", !0 === e && navigator.language && (e = navigator.language.toLowerCase()), e && !o.langList[e]) {
            var i = e.split("-")[0];
            o.langList[i] ? (console.warn("Localization Error - Exact matching locale not found, using closest match: ", e, i), e = i) : (console.warn("Localization Error - Matching locale not found, using default: ", e), e = "default")
        }
        o.locale = e, o.lang = h.prototype.helpers.deepClone(o.langList.default || {}), "default" != e && t(o.langList[e], o.lang), o.table.options.localized.call(o.table, o.locale, o.lang), o._executeBindings()
    ...
    f.prototype.getConnections = function(e) {
        var t, o = this,
            i = [];
        return t = h.prototype.comms.lookupTable(e), t.forEach(function(e) {
            o.table !== e && i.push(e)
        }), i
    ...
    g.prototype.initializeColumn = function(e) {
        ...
        return this.table.columnManager.traverse(function(e) {
            var s, a, r, l;
            e.modules.accessor && (a = e.modules.accessor[o] || e.modules.accessor.accessor || !1) && "undefined" != (s = e.getFieldValue(n)) && (l = e.getComponent(), r = "function" == typeof a.params ? a.params(s, n, t, l, i) : a.params, e.setFieldValue(n, a.accessor(s, n, t, r, l, i)))
        }), n
    ...
    b.prototype.initialize = function() {
        ...
        var e = document.createElement("div");
        return e.classList.add("RCtable-loader"), e
    }, b.prototype.createMsgElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtable-loader-msg"), e.setAttribute("role", "alert"), e
        ...
        if (t = t || "", Array.isArray(e)) e.forEach(function(e, n) {
            ...
            for (var n in e) i = i.concat(o.generateParamsList(e[n], t ? t + "[" + n + "]" : n));
        else i.push({
            key: t,
            value: e
        });
        ...
        if ("function" == typeof this.table.options.ajaxLoader ? this.table.options.ajaxLoader() : this.table.options.ajaxLoader) {
            ...
            this.msgElement.classList.remove("RCtable-error"), this.msgElement.classList.add("RCtable-loading"), this.loadingElement ? this.msgElement.appendChild(this.loadingElement) : this.msgElement.innerHTML = this.table.modules.localize.getText("ajax|loading"), this.table.element.appendChild(this.loaderElement)
        }
    }, b.prototype.showError = function() {
        for (this.hideLoader(); this.msgElement.firstChild;) this.msgElement.removeChild(this.msgElement.firstChild);
        this.msgElement.classList.remove("RCtable-loading"), this.msgElement.classList.add("RCtable-error"), this.errorElement ? this.msgElement.appendChild(this.errorElement) : this.msgElement.innerHTML = this.table.modules.localize.getText("ajax|error"), this.table.element.appendChild(this.loaderElement)
        ...
        return e && o && Object.keys(o).length && (t.method && "get" != t.method.toLowerCase() || (t.method = "get", e += (e.includes("?") ? "&" : "?") + this.modules.ajax.serializeParams(o))), e
    }, b.prototype.defaultLoaderPromise = function(e, t, o) {
        var i, n = this;
        return new Promise(function(s, a) {
            if (e = n.urlGenerator.call(n.table, e, t, o), "GET" != t.method.toUpperCase())
    ...
    y.prototype.createElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtable-calcs-holder"), e
    }, y.prototype.initialize = function() {
        this.genColumn = new n({
            field: "value"
        }, this)
    }, y.prototype.registerColumnField = function() {}, y.prototype.initializeColumn = function(e) {
        var t = e.definition,
            o = {
        ...
        return i.table.modExists("mutator") && i.table.modules.mutator.disable(), o = new l(n, this, "calc"), i.table.modExists("mutator") && i.table.modules.mutator.enable(), o.getElement().classList.add("RCtable-calcs", "RCtable-calcs-" + e), o.component = !1, o.getComponent = function() {
            ...
            i.table.columnManager.columnsByIndex.forEach(function(n) {
                ...
                s.getElement(), s.column = n, s.setWidth(), n.cells.push(s), t.push(s), n.visible || s.hide()
            }), this.cells = t
        }, o
    ...
    w.prototype.initialize = function() {
        ...
        return e.forEach(function(e) {
            ...
            e.columns.forEach(function(t) {
                var i = "";
                if (t)
                    if ("group" === e.type && (t.value = t.component.getKey()), null === t.value) i = "";
                    else switch (_typeof(t.value)) {
                        case "object":
    ...
    E.prototype.initialize = function() {
        var e = null,
            ...
            o = this.table.options;
        switch (this.field = o.dataTreeChildField, this.indent = o.dataTreeChildIndent, this.elementField = o.dataTreeElementColumn || !!t && t.field, o.dataTreeBranchElement && (!0 === o.dataTreeBranchElement ? (this.branchEl = document.createElement("div"), this.branchEl.classList.add("RCtable-data-tree-branch")) : "string" == typeof o.dataTreeBranchElement ? (e = document.createElement("div"), e.innerHTML = o.dataTreeBranchElement, this.branchEl = e.firstChild) : this.branchEl = o.dataTreeBranchElement), o.dataTreeCollapseElement ? "string" == typeof o.dataTreeCollapseElement ? (e = document.createElement("div"), e.innerHTML = o.dataTreeCollapseElement, this.collapseEl = e.firstChild) : this.collapseEl = o.dataTreeCollapseElement : (this.collapseEl = document.createElement("div"), this.collapseEl.classList.add("RCtable-data-tree-control"), this.collapseEl.tabIndex = 0, this.collapseEl.innerHTML = "<div class='RCtable-data-tree-control-collapse'></div>"), o.dataTreeExpandElement ? "string" == typeof o.dataTreeExpandElement ? (e = document.createElement("div"), e.innerHTML = o.dataTreeExpandElement, this.expandEl = e.firstChild) : this.expandEl = o.dataTreeExpandElement : (this.expandEl = document.createElement("div"), this.expandEl.classList.add("RCtable-data-tree-control"), this.expandEl.tabIndex = 0, this.expandEl.innerHTML = "<div class='RCtable-data-tree-control-expand'></div>"), _typeof(o.dataTreeStartExpanded)) {
            case "boolean":
        ...
        return e.forEach(function(e, i) {
            var n, s;
            o.push(e), e instanceof l && (e.create(), n = e.modules.dataTree.children, n.index || !1 === n.children || (s = t.getChildren(e), s.forEach(function(e) {
                e.create(), o.push(e)
            })))
        }), o
        ...
        var o = this,
            ...
            n = [],
            s = [];
        return !1 !== i.children && (i.open || t) && (Array.isArray(i.children) || (i.children = this.generateChildren(e)), n = this.table.modExists("filter") && this.table.options.dataTreeFilter ? this.table.modules.filter.filter(i.children) : i.children, this.table.modExists("sort") && this.table.options.dataTreeSort && this.table.modules.sort.sort(n), n.forEach(function(e) {
        ...
        return Array.isArray(i) || (i = [i]), i.forEach(function(i) {
            ...
            n.create(), n.modules.dataTree.index = e.modules.dataTree.index + 1, n.modules.dataTree.parent = e, n.modules.dataTree.children && (n.modules.dataTree.open = t.startOpen(n.getComponent(), n.modules.dataTree.index)), o.push(n)
        }), o
        ...
        var t, o = e.modules.dataTree,
            i = [];
        return o.children && (Array.isArray(o.children) || (o.children = this.generateChildren(e)), t = this.table.modExists("filter") && this.table.options.dataTreeFilter ? this.table.modules.filter.filter(o.children) : o.children, t.forEach(function(e) {
        ...
        var i = this,
            ...
            s = [];
        return n.children && (Array.isArray(n.children) || (n.children = this.generateChildren(e)), n.children.forEach(function(e) {
            e instanceof l && (s.push(t ? e.getComponent() : e), o && (s = s.concat(i.getTreeChildren(e, t, o))))
        })), s
    ...
    C.prototype.download = function(e, t, o, i, n) {
        ...
        var s = document.createElement("a"),
            ...
            i = i || "RCTable." + ("function" == typeof o ? "txt" : o);
        ...
        xlsx: function(e, t, o) {
            ...
            if (t.sheets)
                for (var l in t.sheets) !0 === t.sheets[l] ? (r.SheetNames.push(l), r.Sheets[l] = i()) : (r.SheetNames.push(l), this.modules.comms.send(t.sheets[l], "download", "intercept", {
                    type: "xlsx",
                    options: {
                        sheetOnly: !0
                    },
    ...
    x.prototype.initializeColumn = function(e) {
        ...
        if (this.invalidEdit = !1, o) {
            for (this.currentCell = !1, t = o.getElement(), e ? o.validate() : t.classList.remove("RCtable-validation-fail"), t.classList.remove("RCtable-editing"); t.firstChild;) t.removeChild(t.firstChild);
            o.row.getElement().classList.remove("RCtable-row-editing")
        }
    }, x.prototype.cancelEdit = function() {
        if (this.currentCell) {
            var e = this.currentCell,
                t = this.currentCell.getComponent();
            this.clearEditor(!0), e.setValueActual(e.getValue()), e.cellRendered(), ("textarea" == e.column.definition.editor || e.column.definition.variableHeight) && e.row.normalizeHeight(!0), e.column.cellEvents.cellEditCancelled && e.column.cellEvents.cellEditCancelled.call(this.table, t), this.table.options.cellEditCancelled.call(this.table, t)
        }
    }, x.prototype.bindEditor = function(e) {
        var t = this,
            o = e.getElement(!0);
        o.setAttribute("tabindex", 0), o.addEventListener("click", function(e) {
            o.classList.contains("RCtable-editing") || o.focus({
                preventScroll: !0
            })
        ...
        function i(t) {
            if (c.currentCell === e) {
                var o = !0;
                return e.column.modules.validate && c.table.modExists("validate") && "manual" != c.table.options.validationMode && (o = c.table.modules.validate.validate(e.column.modules.validate, e, t)), !0 === o || "highlight" === c.table.options.validationMode ? (c.clearEditor(), e.modules.edit || (e.modules.edit = {}), e.modules.edit.edited = !0, -1 == c.editedCells.indexOf(e) && c.editedCells.push(e), e.setValue(t, !0), c.table.options.dataTree && c.table.modExists("dataTree") && c.table.modules.dataTree.checkForRestyle(e), !0 === o || (h.classList.add("RCtable-validation-fail"), c.table.options.validationFailed.call(c.table, e.getComponent(), t, o), !1)) : (c.invalidEdit = !0, h.classList.add("RCtable-validation-fail"), c.focusCellNoEvent(e, !0), d(), c.table.options.validationFailed.call(c.table, e.getComponent(), t, o), !1)
            }
        }
        ...
        if (u || o) {
            ...
            for (h.classList.add("RCtable-editing"), e.row.getElement().classList.add("RCtable-row-editing"); h.firstChild;) h.removeChild(h.firstChild);
            h.appendChild(a), d();
        ...
        var t;
        e.modules.edit && e.modules.edit.edited && (e.modules.edit.edited = !1, e.modules.validate && (e.modules.validate.invalid = !1)), (t = this.editedCells.indexOf(e)) > -1 && this.editedCells.splice(t, 1)
    }, x.prototype.editors = {
        ...
        textarea: function(e, t, o, i, n) {
            ...
            var a = e.getValue(),
                ...
                u = 0;
            if (c.style.display = "block", c.style.padding = "2px", c.style.height = "100%", c.style.width = "100%", c.style.boxSizing = "border-box", c.style.whiteSpace = "pre-wrap", c.style.resize = "none",
            ...
            return c.value = l, t(function() {
                c.focus({
                    preventScroll: !0
                }), c.style.height = "100%", c.scrollHeight, c.style.height = c.scrollHeight + "px", e.getRow().normalizeHeight()
        ...
        select: function(e, t, o, i, n) {
            function s(t) {
                var o, i = {},
                    n = x.table.getData();
                return o = t ? x.table.columnManager.getColumnByField(t) : e.getColumn()._getSelf(), o ? n.forEach(function(e) {
                    var t = o.getFieldValue(e);
                    null !== t && void 0 !== t && "" !== t && (i[t] = !0)
                }) : console.warn("unable to find matching column to create select lookup list:", t), Object.keys(i)
            }
            ...
            function a(t, o) {
                ...
                if ("function" == typeof t && (t = t(e)), Array.isArray(t)) t.forEach(function(e) {
                    ...
                    "object" === (void 0 === e ? "undefined" : _typeof(e)) ? e.options ? (t = {
                        ...
                        elementAttributes: e.elementAttributes,
                        element: !1
                    }, a.push(t), e.options.forEach(function(e) {
                        i(e)
                    })) : i(e): (t = {
                        label: e,
                        value: e,
                        element: !1
                    }, o.indexOf(t.value) > -1 && c(t), s.push(t), a.push(t))
                });
                else
                    for (var l in t) {
                        var u = {
                ...
                n.sortValuesList && (s.sort(function(e, t) {
                    ...
                    return e.label < t.label ? -1 : e.label > t.label ? 1 : 0
                }), "asc" !== n.sortValuesList && (s.reverse(), a.reverse())), S = s, P = a, r()
            }
            ...
            function r() {
                ...
                P.forEach(function(t) {
                    var o = t.element;
                    if (!o) {
                        if (o = document.createElement("div"), t.label = n.listItemFormatter ? n.listItemFormatter(t.value, t.label, e, o, t.itemParams) : t.label, t.group ? (o.classList.add("RCtable-edit-select-list-group"), o.tabIndex = 0, o.innerHTML = "" === t.label ? "&nbsp;" : t.label) : (o.classList.add("RCtable-edit-select-list-item"), o.tabIndex = 0, o.innerHTML = "" === t.label ? "&nbsp;" : t.label, o.addEventListener("click", function() {
                                F = !0, setTimeout(function() {
                                    F = !1
                                }, 10), z ? (d(t), T.focus()) : p(t)
                            }), A.indexOf(t) > -1 && o.classList.add("active")), t.elementAttributes && "object" == _typeof(t.elementAttributes))
                            for (var i in t.elementAttributes) "+" == i.charAt(0) ? (i = i.slice(1), o.setAttribute(i, T.getAttribute(i) + t.elementAttributes["+" + i])) : o.setAttribute(i, t.elementAttributes[i]);
            ...
            function l(e, t) {
                !z && H && H.element && H.element.classList.remove("active"), H && H.element && H.element.classList.remove("focused"), H = e, e.element && (e.element.classList.add("focused"), t && e.element.classList.add("active")), e && e.element && e.element.scrollIntoView && e.element.scrollIntoView({
                    behavior: "smooth",
                    block: "nearest",
                    inline: "start"
                })
            ...
            function p(e) {
                y(), e || (e = H), e && (T.value = e.label, o(e.value)), D = [e.value]
            }
            ...
            function f() {
                ...
                A.forEach(function(t) {
                    e.push(t.label)
                }), T.value = e.join(", "), !1 === x.currentCell && m(!0)
            }
            ...
            function v() {
                if (A = [], !k.parentNode) {
                    ...
                    k.style.minWidth = R.offsetWidth + "px", k.style.top = e.top + R.offsetHeight + "px", k.style.left = e.left + "px", k.addEventListener("mousedown", function(e) {
                        _ = !1, setTimeout(function() {
                            _ = !0
                        }, 10)
            ...
            var C = this,
                ...
                N = "",
                B = null;
            if ((Array.isArray(n) || !Array.isArray(n) && "object" === (void 0 === n ? "undefined" : _typeof(n)) && !n.values) && (console.warn("DEPRECATION WARNING - values for the select editor must now be passed into the values property of the editorParams object, not as the editorParams object"), n = {
                    values: n
                }), T.setAttribute("type", "text"), T.style.padding = "4px", T.style.width = "100%", T.style.boxSizing = "border-box", T.style.cursor = "default", T.readOnly = 0 != this.currentCell, n.elementAttributes && "object" == _typeof(n.elementAttributes))
            ...
            return T.value = void 0 !== M || null === M ? M : "", T.addEventListener("search", function(e) {
                T.value || (g(), m())
            }), T.addEventListener("keydown", function(e) {
                var t;
                switch (e.keyCode) {
                    case 38:
                        t = S.indexOf(H), ("editor" == L || "hybrid" == L && t) && (e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault(), t > 0 && l(S[t - 1], !z));
                        break;
                    case 40:
                        t = S.indexOf(H), ("editor" == L || "hybrid" == L && t < S.length - 1) && (e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault(), t < S.length - 1 && (-1 == t ? l(S[0], !z) : l(S[t + 1], !z)));
                        break;
                    case 37:
                    case 39:
                    ...
                    case 9:
                        break;
                    default:
                        !1 === x.currentCell && e.preventDefault(), e.keyCode >= 38 && e.keyCode <= 90 && E(e.keyCode)
                }
            }), T.addEventListener("blur", function(e) {
                _ && (z ? m() : b())
            }), T.addEventListener("focus", function(e) {
                F || v()
            }), k = document.createElement("div"), k.classList.add("RCtable-edit-select-list"), t(function() {
                T.style.height = "100%", T.focus({
                    preventScroll: !0
                })
            }), setTimeout(function() {
        ...
        autocomplete: function(e, t, o, i, n) {
            ...
            function r(e, t) {
                ...
                })) : d(c(s), t)) : (i = c(o), "" === e ? n.showListOnEmpty && (s = i) : i.forEach(function(t) {
            ...
            function l(e) {
                ...
                u(), !1 !== e && (t.classList.add("RCtable-edit-select-list-notice"), t.tabIndex = 0, e instanceof Node ? t.appendChild(e) : t.innerHTML = e, D.appendChild(t))
            }
            ...
            function p(e, t) {
                ...
                u(), T = e, T.forEach(function(e) {
                    var i = e.element;
                    i || (i = document.createElement("div"), i.classList.add("RCtable-edit-select-list-item"), i.tabIndex = 0, i.innerHTML = e.title, i.addEventListener("click", function(t) {
                        g(e), m()
                    }), i.addEventListener("mousedown", function(e) {
                        z = !1, setTimeout(function() {
                            z = !0
                        }, 10)
                    }), e.element = i, t && e.value == x && (L.value = e.title, e.element.classList.add("active"), o = !0), e === k && (e.element.classList.add("active"), o = !0)), D.appendChild(i)
                }), o || g(!1)
            }
            ...
            function f() {
                if (!D.parentNode) {
                    ...
                    D.style.minWidth = C.offsetWidth + "px", D.style.top = e.top + C.offsetHeight + "px", D.style.left = e.left + "px", document.body.appendChild(D)
                }
            }

            function g(e, t) {
                k && k.element && k.element.classList.remove("active"), k = e, e && e.element && e.element.classList.add("active"), e && e.element && e.element.scrollIntoView && e.element.scrollIntoView({
                    behavior: "smooth",
                    block: "nearest",
                    inline: "start"
                })
            ...
            return D.classList.add("RCtable-edit-select-list"), D.addEventListener("mousedown", function(e) {
                z = !1, setTimeout(function() {
                    z = !0
                }, 10)
            }), L.addEventListener("keydown", function(e) {
                ...
                switch (e.keyCode) {
                    case 38:
                        t = T.indexOf(k), ("editor" == R || "hybrid" == R && t) && (e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault(), g(t > 0 ? T[t - 1] : !1));
                        break;
                    case 40:
                        t = T.indexOf(k), ("editor" == R || "hybrid" == R && t < T.length - 1) && (e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault(), t < T.length - 1 && g(-1 == t ? T[0] : T[t + 1]));
                        break;
                    case 37:
                    case 39:
        ...
        star: function(e, t, o, i, n) {
            function s(e) {
                h.forEach(function(t, o) {
                    o < e ? ("ie" == r.table.browser ? t.setAttribute("class", "RCtable-star-active") : t.classList.replace("RCtable-star-inactive", "RCtable-star-active"), t.innerHTML = '<polygon fill="#488CE9" stroke="#014AAE" stroke-width="37.6152" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" points="259.216,29.942 330.27,173.919 489.16,197.007 374.185,309.08 401.33,467.31 259.216,392.612 117.104,467.31 144.25,309.08 29.274,197.007 188.165,173.919 "/>') : ("ie" == r.table.browser ? t.setAttribute("class", "RCtable-star-inactive") : t.classList.replace("RCtable-star-active", "RCtable-star-inactive"), t.innerHTML = '<polygon fill="#010155" stroke="#686868" stroke-width="37.6152" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" points="259.216,29.942 330.27,173.919 489.16,197.007 374.185,309.08 401.33,467.31 259.216,392.612 117.104,467.31 144.25,309.08 29.274,197.007 188.165,173.919 "/>')
                })
            }
        ...
        progress: function(e, t, o, i, n) {
            ...
            if (p.style.position = "absolute", p.style.right = "0", p.style.top = "0", p.style.bottom = "0", p.style.width = "5px", p.classList.add("RCtable-progress-handle"), m.style.display = "inline-block", m.style.position = "relative", m.style.height = "100%", m.style.backgroundColor = "#488CE9", m.style.maxWidth = "100%", m.style.minWidth = "0%", n.elementAttributes && "object" == _typeof(n.elementAttributes))
        ...
        tickCross: function(e, t, o, i, n) {
            ...
            }), r.checked = !0 === a || "true" === a || "True" === a || 1 === a, t(function() {
                r.focus()
    ...
    L.prototype.generateExportList = function(e, t, o, i) {
        ...
        function t(e, n) {
            ...
            if (e.width > 1)
                for (var r = 1; r < e.width; r++) o[n].push(!1);
        ...
        return this.table.columnManager.columnsByIndex.forEach(function(e) {
            ...
            switch (e.type) {
                case "group":
                    r = e.level, a.push(new M(e.key, e.getComponent(), o.length, 1));
                    break;
                case "calc":
                case "row":
                    o.forEach(function(e) {
        ...
        var e = {};
        return this.cloneTableStyle && window.getComputedStyle && (e.oddRow = this.table.element.querySelector(".RCtable-row-odd:not(.RCtable-group):not(.RCtable-calcs)"), e.evenRow = this.table.element.querySelector(".RCtable-row-even:not(.RCtable-group):not(.RCtable-calcs)"), e.calcRow = this.table.element.querySelector(".RCtable-row.RCtable-calcs"), e.firstRow = this.table.element.querySelector(".RCtable-row:not(.RCtable-group):not(.RCtable-calcs)"), e.firstGroup = this.table.element.getElementsByClassName("RCtable-group")[0], e.firstRow && (e.styleCells = e.firstRow.getElementsByClassName("RCtable-cell"), e.firstCell = e.styleCells[0], e.lastCell = e.styleCells[e.styleCells.length - 1])), e
        ...
        var i = document.createElement("tr"),
            ...
            s = e.columns[0];
        return i.classList.add("RCtable-print-table-row"), t.groupHeader && t.groupHeader[e.indent] ? s.value = t.groupHeader[e.indent](s.value, e.component._group.getRowCount(), e.component._group.getData(), e.component) : !1 === t.groupHeader ? s.value = s.value : s.value = e.component._group.generator(s.value, e.component._group.getRowCount(), e.component._group.getData(), e.component), n.colSpan = s.width, n.innerHTML = s.value, i.classList.add("RCtable-print-table-group"), i.classList.add("RCtable-group-level-" + e.indent), s.component.isVisible() && i.classList.add("RCtable-group-visible"), this.mapElementStyles(o.firstGroup, i, ["border-top", "border-left", "border-right", "border-bottom", "color", "font-weight", "font-family", "font-size", "background-color"]), this.mapElementStyles(o.firstGroup, n, ["padding-top", "padding-left", "padding-right", "padding-bottom"]), i.appendChild(n), i
    }, L.prototype.genereateCalcElement = function(e, t, o) {
        var i = this.genereateRowElement(e, t, o);
        return i.classList.add("RCtable-print-table-calcs"), this.mapElementStyles(o.calcRow, i, ["border-top", "border-left", "border-right", "border-bottom", "color", "font-weight", "font-family", "font-size", "background-color"]), i
    }, L.prototype.genereateRowElement = function(e, t, o) {
        var n = this,
            s = document.createElement("tr");
        return s.classList.add("RCtable-print-table-row"), e.columns.forEach(function(a) {
            if (a) {
                ...
                if ((l.definition.cssClass ? l.definition.cssClass.split(" ") : []).forEach(function(e) {
                        r.classList.add(e)
                    }), n.table.modExists("format") && !1 !== n.config.formatCells) c = n.table.modules.format.formatExportValue(u, n.colVisProp);
    ...
    D.prototype.initializeColumn = function(e, t) {
        function o(t) {
            var o, a = "input" == e.modules.filter.tagType && "text" == e.modules.filter.attrType || "textarea" == e.modules.filter.tagType ? "partial" : "match",
                r = "",
                l = "";
        ...
        if (e.modules.filter.headerElement && e.modules.filter.headerElement.parentNode && e.contentElement.removeChild(e.modules.filter.headerElement.parentNode), m) {
            switch (e.modules.filter.emptyFunc = e.definition.headerFilterEmptyCheck || function(e) {
                return !e && "0" !== e && 0 !== e
            }, n = document.createElement("div"), n.classList.add("RCtable-header-filter"), _typeof(e.definition.headerFilter)) {
                case "string":
            ...
            if (s) {
                if (r = {
                    ...
                    }, u = e.definition.headerFilterParams || {}, u = "function" == typeof u ? u.call(h.table) : u, !(a = s.call(this.table.modules.edit, r, function() {}, p, i, u))) return void console.warn("Filter Error - Cannot add filter to " + m + " column, editor returned a value of false");
    ...
    T.prototype.initializeColumn = function(e) {
        ...
        money: function(e, t, o) {
            var i, n, s, a, r = parseFloat(e.getValue()),
                l = t.decimal || ".",
                c = t.thousand || ",",
                u = t.symbol || "",
                d = !!t.symbolAfter,
        ...
        image: function(e, t, o) {
            var i = document.createElement("img"),
                n = e.getValue();
            switch (t.urlPrefix && (n = t.urlPrefix + e.getValue()), t.urlSuffix && (n += t.urlSuffix), i.setAttribute("src", n), _typeof(t.height)) {
                case "number":
        ...
        traffic: function(e, t, o) {
            var i, n, s = this.sanitizeHTML(e.getValue()) || 0,
                a = document.createElement("span"),
                r = t && t.max ? t.max : 100,
                l = t && t.min ? t.min : 0,
            ...
            if (!isNaN(s) && void 0 !== e.getValue()) {
                switch (a.classList.add("RCtable-traffic-light"), n = parseFloat(s) <= r ? parseFloat(s) : r, n = parseFloat(n) >= l ? parseFloat(n) : l, i = (r - l) / 100, n = Math.round((n - l) / i), void 0 === c ? "undefined" : _typeof(c)) {
                    case "string":
                        u = c;
                        break;
                    case "function":
        ...
        progress: function(e, t, o) {
            var i, n, s, a, r, l = this.sanitizeHTML(e.getValue()) || 0,
                u = e.getElement(),
                d = t && t.max ? t.max : 100,
                h = t && t.min ? t.min : 0,
                p = t && t.legendAlign ? t.legendAlign : "center";
            switch (n = parseFloat(l) <= d ? parseFloat(l) : d, n = parseFloat(n) >= h ? parseFloat(n) : h, i = (d - h) / 100, n = Math.round((n - h) / i), _typeof(t.color)) {
                case "string":
                    s = t.color;
                    break;
                case "function":
        ...
        handle: function(e, t, o) {
            return e.getElement().classList.add("RCtable-row-handle"), "<div class='RCtable-row-handle-box'><div class='RCtable-row-handle-bar'></div><div class='RCtable-row-handle-bar'></div><div class='RCtable-row-handle-bar'></div></div>"
        },
        responsiveCollapse: function(e, t, o) {
            ...
            return n.classList.add("RCtable-responsive-collapse-toggle"), n.innerHTML = "<span class='RCtable-responsive-collapse-toggle-open'>+</span><span class='RCtable-responsive-collapse-toggle-close'>-</span>", e.getElement().classList.add("RCtable-row-handle"), n.addEventListener("click", function(e) {
            ...
            if (n.type = "checkbox", this.table.modExists("selectRow", !0))
                if (n.addEventListener("click", function(e) {
                    ...
                    s instanceof r ? (n.addEventListener("change", function(e) {
                        s.toggleSelect()
                    }), n.checked = s.isSelected && s.isSelected(), this.table.modules.selectRow.registerRowSelectCheckbox(s, n)) : n = ""
                } else n.addEventListener("change", function(e) {
    ...
    k.prototype.reset = function() {
        ...
        this.leftColumns.forEach(function(i, n) {
            if (i.modules.frozen.margin = t._calcSpace(t.leftColumns, n) + t.table.columnManager.scrollLeft + "px", n == t.leftColumns.length - 1 ? i.modules.frozen.edge = !0 : i.modules.frozen.edge = !1, i.parent.isGroup) {
                ...
                o.includes(s) || (t.layoutElement(s, i), o.push(s)), i.modules.frozen.edge && s.classList.add("RCtable-frozen-" + i.modules.frozen.position)
        ...
        t.modules.frozen && (e.style.position = "absolute", e.style.left = t.modules.frozen.margin, e.classList.add("RCtable-frozen"), t.modules.frozen.edge && e.classList.add("RCtable-frozen-" + t.modules.frozen.position))
    ...
    z.prototype.initialize = function() {
        this.rows = [], this.topElement.classList.add("RCtable-frozen-rows-holder"), this.table.columnManager.getElement().insertBefore(this.topElement, this.table.columnManager.headersElement.nextSibling)
    ...
    H.prototype.wipe = function() {
        ...
        var e = document.createElement("div");
        e.classList.add("RCtable-arrow"), this.element = document.createElement("div"), this.element.classList.add("RCtable-row"), this.element.classList.add("RCtable-group"), this.element.classList.add("RCtable-group-level-" + this.level), this.element.setAttribute("role", "rowgroup"), this.arrowElement = document.createElement("div"), this.arrowElement.classList.add("RCtable-group-toggle"), this.arrowElement.appendChild(e), !1 !== this.groupManager.table.options.movableRows && this.groupManager.table.modExists("moveRow") && this.groupManager.table.modules.moveRow.initializeGroupHeader(this)
        ...
        }), (n.groupManager.table.options.groupContextMenu || n.groupManager.table.options.groupClickMenu) && n.groupManager.table.modExists("menu") && n.groupManager.table.modules.menu.initializeGroup.call(n.groupManager.table.modules.menu, n), n.groupManager.table.options.groupTap && (o = !1, n.element.addEventListener("touchstart", function(e) {
            o = !0
        }, {
            passive: !0
        ...
        this.visible = !1, "classic" != this.groupManager.table.rowManager.getRenderMode() || this.groupManager.table.options.pagination ? this.groupManager.updateGroupRows(!0) : (this.element.classList.remove("RCtable-group-visible"), this.groupList.length ? this.groupList.forEach(function(e) {
        ...
        if (e.visible = !0, "classic" != this.groupManager.table.rowManager.getRenderMode() || this.groupManager.table.options.pagination) this.groupManager.updateGroupRows(!0);
            ...
            this.element.classList.add("RCtable-group-visible");
            var t = e.getElement();
            this.groupList.length ? this.groupList.forEach(function(e) {
                e.getHeadersAndRows().forEach(function(e) {
                    var o = e.getElement();
        ...
        this.addBindingsd = !1, this._visSet(), this.visible ? this.element.classList.add("RCtable-group-visible") : this.element.classList.remove("RCtable-group-visible");
        ...
        return this
    }, H.prototype.reinitializeHeight = function() {}, H.prototype.calcHeight = function() {}, H.prototype.setCellHeight = function() {}, H.prototype.clearCellHeight = function() {}, H.prototype.getComponent = function() {
    ...
    P.prototype.initialize = function() {
        ...
        if (this.allowedValues = e.table.options.groupValues, Array.isArray(t) && Array.isArray(i) && t.length > i.length && console.warn("Error creating group headers, groupHeader array is shorter than groupBy array"), e.headerGenerator = [function() {
            ...
            }), this.groupIDLookups = [], Array.isArray(t) || t) this.table.modExists("columnCalcs") && "table" != this.table.options.columnCalcs && "both" != this.table.options.columnCalcs && this.table.modules.columnCalcs.removeCalcs();
        ...
        var i, n = t + "_" + e;
        o = o || [], i = new H(this, !1, t, e, this.groupIDLookups[0].field, this.headerGenerator[0], o[n]), this.groups[n] = i, this.groupList.push(i)
        ...
        this.table.options.virtualDomHoz && (e -= this.table.vdomHoz.vDomPadLeft), e += "px", this.groupList.forEach(function(t) {
            t.scrollHeader(e)
        })
    ...
    _.prototype.parseTable = function() {
        ...
        for (var a in i) {
            var r, l = i[a];
            l && "object" == (void 0 === l ? "undefined" : _typeof(l)) && l.name && 0 === l.name.indexOf("RCtable-") && (r = l.name.replace("RCtable-", ""), void 0 !== s[r] && (t[s[r]] = this._attribValue(l.value)))
        }
        ...
        for (var o = 0; o < e.length; o++) {
            ...
            }, r.field || (r.field = s.textContent.trim().toLowerCase().replace(" ", "_")), i = s.getAttribute("width"), i && !r.width && (r.width = i), s.attributes, this._extractOptions(s, r, n.prototype.defaultOptionList), this.fieldIndex[o] = r.field, r.field == this.table.options.index && (this.hasIndex = !0), a || this.table.options.columns.push(r)
        }
    ...
    var N = function(e) {
        this.table = e, this.menuElements = [], this.blurEvent = this.hideMenu.bind(this), this.escEvent = this.escMenu.bind(this), this.nestedMenuBlock = !1, this.positionReversedX = !1
    };
    N.prototype.initializeColumnHeader = function(e) {
        var t, o = this;
        e.definition.headerContextMenu && (e.getElement().addEventListener("contextmenu", this.LoadMenuEvent.bind(this, e, e.definition.headerContextMenu)), this.tapHold(e, e.definition.headerContextMenu)), e.definition.headerMenu && (t = document.createElement("span"), t.classList.add("RCtable-header-menu-button"), t.innerHTML = "&vellip;", t.addEventListener("click", function(t) {
            t.stopPropagation(), t.preventDefault(), o.LoadMenuEvent(e, e.definition.headerMenu, t)
        ...
        e.column.definition.contextMenu && (e.getElement(!0).addEventListener("contextmenu", this.LoadMenuEvent.bind(this, e, e.column.definition.contextMenu)), this.tapHold(e, e.column.definition.contextMenu)), e.column.definition.clickMenu && e.getElement(!0).addEventListener("click", this.LoadMenuEvent.bind(this, e, e.column.definition.clickMenu))
    }, N.prototype.initializeRow = function(e) {
        this.table.options.rowContextMenu && (e.getElement().addEventListener("contextmenu", this.LoadMenuEvent.bind(this, e, this.table.options.rowContextMenu)), this.tapHold(e, this.table.options.rowContextMenu)), this.table.options.rowClickMenu && e.getElement().addEventListener("click", this.LoadMenuEvent.bind(this, e, this.table.options.rowClickMenu))
        ...
        if (a.classList.add("RCtable-menu"), s || e.preventDefault(), o && o.length) {
            if (!i) {
            ...
            o.forEach(function(e) {
                var o = document.createElement("div"),
                    i = e.label,
                    s = e.disabled;
                e.separator ? o.classList.add("RCtable-menu-separator") : (o.classList.add("RCtable-menu-item"), "function" == typeof i && (i = i.call(n.table, t.getComponent())), i instanceof Node ? o.appendChild(i) : o.innerHTML = i, "function" == typeof s && (s = s.call(n.table, t.getComponent())), s ? (o.classList.add("RCtable-menu-item-disabled"), o.addEventListener("click", function(e) {
                    e.stopPropagation()
                })) : e.menu && e.menu.length ? o.addEventListener("click", function(i) {
                    i.stopPropagation(), n.hideOldSubMenus(a), n.loadMenu(i, t, e.menu, o)
                }) : e.action && o.addEventListener("click", function(o) {
                    e.action(o, t.getComponent())
                }), e.menu && e.menu.length && o.classList.add("RCtable-menu-item-submenu")), a.appendChild(o)
            }), a.addEventListener("click", function(e) {
                n.hideMenu()
            }), this.menuElements.push(a), this.positionMenu(a, i, s, e)
        }
        ...
        t ? (a = h.prototype.helpers.elOffset(t), n = a.left + t.offsetWidth, s = a.top - 1) : (n = o ? i.touches[0].pageX : i.pageX, s = o ? i.touches[0].pageY : i.pageY, this.positionReversedX = !1), e.style.top = s + "px", e.style.left = n + "px", setTimeout(function() {
            r.table.rowManager.element.addEventListener("scroll", r.blurEvent), document.body.addEventListener("click", r.blurEvent), document.body.addEventListener("contextmenu", r.blurEvent), window.addEventListener("resize", r.blurEvent), document.body.addEventListener("keydown", r.escEvent)
        }, 100), document.body.appendChild(e), s + e.offsetHeight >= l && (e.style.top = "", e.style.bottom = t ? l - a.top - t.offsetHeight - 1 + "px" : l - s + "px"), (n + e.offsetWidth >= document.body.offsetWidth || this.positionReversedX) && (e.style.left = "", e.style.right = t ? document.documentElement.offsetWidth - a.left + "px" : document.documentElement.offsetWidth - n + "px", this.positionReversedX = !0)
        ...
        }), document.body.removeEventListener("keydown", this.escEvent), document.body.removeEventListener("click", this.blurEvent), document.body.removeEventListener("contextmenu", this.blurEvent), window.removeEventListener("resize", this.blurEvent), this.table.rowManager.element.removeEventListener("scroll", this.blurEvent)
    }, N.prototype.menus = {}, h.prototype.registerModule("menu", N);
    var B = function(e) {
    ...
    B.prototype.createPlaceholderElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtable-col"), e.classList.add("RCtable-col-placeholder"), e
    }, B.prototype.initializeColumn = function(e) {
        var t, o = this,
            i = {};
        e.modules.frozen || (t = e.getElement(), i.mousemove = function(i) {
            e.parent === o.moving.parent && ((o.touchMove ? i.touches[0].pageX : i.pageX) - h.prototype.helpers.elOffset(t).left + o.table.columnManager.element.scrollLeft > e.getWidth() / 2 ? o.toCol === e && o.toColAfter || (t.parentNode.insertBefore(o.placeholderElement, t.nextSibling), o.moveColumn(e, !0)) : (o.toCol !== e || o.toColAfter) && (t.parentNode.insertBefore(o.placeholderElement, t), o.moveColumn(e, !1)))
        ...
        var o = t.getElement();
        this.moving = t, this.startX = (this.touchMove ? e.touches[0].pageX : e.pageX) - h.prototype.helpers.elOffset(o).left, this.table.element.classList.add("RCtable-block-select"), this.placeholderElement.style.width = t.getWidth() + "px", this.placeholderElement.style.height = t.getHeight() + "px", o.parentNode.insertBefore(this.placeholderElement, o), o.parentNode.removeChild(o), this.hoverElement = o.cloneNode(!0), this.hoverElement.classList.add("RCtable-moving"), this.table.columnManager.getElement().appendChild(this.hoverElement), this.hoverElement.style.left = "0", this.hoverElement.style.bottom = "0", this.touchMove || (this._bindMouseMove(), document.body.addEventListener("mousemove", this.moveHover), document.body.addEventListener("mouseup", this.endMove)), this.moveHover(e)
    ...
    O.prototype.createPlaceholderElement = function() {
        var e = document.createElement("div");
        return e.classList.add("RCtable-row"), e.classList.add("RCtable-row-placeholder"), e
        ...
        i.mouseup = function(t) {
            ...
            var i = e.getElement();
            t.pageY - h.prototype.helpers.elOffset(i).top + o.table.rowManager.element.scrollTop > e.getHeight() / 2 ? o.toRow === e && o.toRowAfter || (i.parentNode.insertBefore(o.placeholderElement, i.nextSibling), o.moveRow(e, !0)) : (o.toRow !== e || o.toRowAfter) && (i.parentNode.insertBefore(o.placeholderElement, i), o.moveRow(e, !1))
        ...
        var o = t.getElement();
        this.setStartPosition(e, t), this.moving = t, this.table.element.classList.add("RCtable-block-select"), this.placeholderElement.style.width = t.getWidth() + "px", this.placeholderElement.style.height = t.getHeight() + "px", this.connection ? (this.table.element.classList.add("RCtable-movingrow-sending"), this.connectToTables(t)) : (o.parentNode.insertBefore(this.placeholderElement, o), o.parentNode.removeChild(o)), this.hoverElement = o.cloneNode(!0), this.hoverElement.classList.add("RCtable-moving"), this.connection ? (document.body.appendChild(this.hoverElement), this.hoverElement.style.left = "0", this.hoverElement.style.top = "0", this.hoverElement.style.width = this.table.element.clientWidth + "px", this.hoverElement.style.whiteSpace = "nowrap", this.hoverElement.style.overflow = "hidden", this.hoverElement.style.pointerEvents = "none") : (this.table.rowManager.getTableElement().appendChild(this.hoverElement), this.hoverElement.style.left = "0", this.hoverElement.style.top = "0", this._bindMouseMove()), document.body.addEventListener("mousemove", this.moveHover), document.body.addEventListener("mouseup", this.endMove), this.moveHover(e)
    }, O.prototype.setStartPosition = function(e, t) {
        var o, i, n = this.touchMove ? e.touches[0].pageX : e.pageX,
        ...
        e && 1 !== e.which && !this.touchMove || (this._unbindMouseMove(), this.connection || (this.placeholderElement.parentNode.insertBefore(this.moving.getElement(), this.placeholderElement.nextSibling), this.placeholderElement.parentNode.removeChild(this.placeholderElement)), this.hoverElement.parentNode.removeChild(this.hoverElement), this.table.element.classList.remove("RCtable-block-select"), this.toRow && this.table.rowManager.moveRow(this.moving, this.toRow, this.toRowAfter), this.moving = !1, this.toRow = !1, this.toRowAfter = !1, document.body.removeEventListener("mousemove", this.moveHover), document.body.removeEventListener("mouseup", this.endMove), this.connection && (this.table.element.classList.remove("RCtable-movingrow-sending"), this.disconnectFromTables()))
        ...
        this.connectionSelectorsTables && (t = this.table.modules.comms.getConnections(this.connectionSelectorsTables), this.table.options.movableRowsSendingStart.call(this.table, t), this.table.modules.comms.send(this.connectionSelectorsTables, "moveRow", "connect", {
            ...
            e.addEventListener("mouseup", t), e.RCtableElementDropEvent = t, e.classList.add("RCtable-movingrow-receiving")
        }))
        ...
        this.connectionSelectorsTables && (e = this.table.modules.comms.getConnections(this.connectionSelectorsTables), this.table.options.movableRowsSendingStop.call(this.table, e), this.table.modules.comms.send(this.connectionSelectorsTables, "moveRow", "disconnect")), this.connectionElements.forEach(function(e) {
            e.classList.remove("RCtable-movingrow-receiving"), e.removeEventListener("mouseup", e.RCtableElementDropEvent), delete e.RCtableElementDropEvent
        })
    }, O.prototype.connect = function(e, t) {
        var o = this;
        return this.connectedTable ? (console.warn("Move Row Error - Table cannot accept connection, already connected to table:", this.connectedTable), !1) : (this.connectedTable = e, this.connectedRow = t, this.table.element.classList.add("RCtable-movingrow-receiving"), o.table.rowManager.getDisplayRows().forEach(function(e) {
        ...
        var t = this;
        e === this.connectedTable ? (this.connectedTable = !1, this.connectedRow = !1, this.table.element.classList.remove("RCtable-movingrow-receiving"), t.table.rowManager.getDisplayRows().forEach(function(e) {
    ...
    I.prototype.initializeColumn = function(e) {
        ...
        return this.enabled && n.table.columnManager.traverse(function(n) {
            var a, r, l;
            n.modules.mutate && (a = n.modules.mutate[s] || n.modules.mutate.mutator || !1) && (i = n.getFieldValue(void 0 !== o ? o : e), "data" != t && void 0 === i || (l = n.getComponent(), r = "function" == typeof a.params ? a.params(i, e, t, l) : a.params, n.setFieldValue(e, a.mutator(i, e, t, r, l))))
        }), e
        ...
        this.enabled = !1
    }, I.prototype.mutators = {}, h.prototype.registerModule("mutator", I);
    var V = function(e) {
    ...
    V.prototype.createElements = function() {
        var e;
        this.element = document.createElement("span"), this.element.classList.add("RCtable-paginator"), this.pagesElement = document.createElement("span"), this.pagesElement.classList.add("RCtable-pages"), e = document.createElement("button"), e.classList.add("RCtable-page"), e.setAttribute("type", "button"), e.setAttribute("role", "button"), e.setAttribute("aria-label", ""), e.setAttribute("title", ""), this.firstBut = e.cloneNode(!0), this.firstBut.setAttribute("data-page", "first"), this.prevBut = e.cloneNode(!0), this.prevBut.setAttribute("data-page", "prev"), this.nextBut = e.cloneNode(!0), this.nextBut.setAttribute("data-page", "next"), this.lastBut = e.cloneNode(!0), this.lastBut.setAttribute("data-page", "last"), this.table.options.paginationSizeSelector && (this.pageSizeSelect = document.createElement("select"), this.pageSizeSelect.classList.add("RCtable-page-size"))
        ...
        return new Promise(function(i, n) {
            e = parseInt(e), e > 0 && e <= t.max || "local" !== t.mode ? (t.page = e, t.trigger().then(function() {
                i()
            }).catch(function() {
                n()
        ...
        return o.classList.add("RCtable-page"), e == t.page && o.classList.add("active"), o.setAttribute("type", "button"), o.setAttribute("role", "button"), t.table.modules.localize.bind("pagination|page_title", function(t) {
        ...
        var t, o, i;
        if ("local" == this.mode) {
            t = [], !0 === this.size ? (o = 0, i = e.length) : (o = this.size * (this.page - 1), i = o + parseInt(this.size)), this._setPageButtons();
        ...
        var e, t, o = this,
            i = this;
        return new Promise(function(n, s) {
            if (i.table.modExists("ajax", !0) || s(), e = h.prototype.helpers.deepClone(i.table.modules.ajax.getParams() || {}), t = i.table.modules.ajax.getParams(), t[o.dataSentNames.page] = i.page, o.size && (t[o.dataSentNames.size] = o.size), o.table.options.ajaxSorting && o.table.modExists("sort")) {
    ...
    j.prototype.localStorageTest = function() {
        ...
        var e, t = this.table.options.persistenceMode,
        ...
        return e.forEach(function(e) {
            var n, s = {},
                a = e.getDefinition();
            e.isGroup ? (s.title = a.title, s.columns = t.parseColumns(e.getColumns())) : (s.field = e.getField(), !0 === t.config.columns || void 0 == t.config.columns ? (n = Object.keys(a), n.push("width")) : n = t.config.columns, n.forEach(function(t) {
                switch (t) {
                    case "width":
                        s.width = e.getWidth();
                        break;
    ...
    W.prototype.initialize = function() {
        ...
        this.manualBlock || (this.element = document.createElement("div"), this.element.classList.add("RCtable-print-table"), this.element.appendChild(this.table.modules.export.genereateTable(this.table.options.printConfig, this.table.options.printStyled, this.table.options.printRowRange, "print")), this.table.element.style.display = "none", this.table.element.parentNode.insertBefore(this.element, this.table.element))
    }, W.prototype.cleanup = function() {
        document.body.classList.remove("RCtable-print-fullscreen-hide"), this.element && this.element.parentNode && (this.element.parentNode.removeChild(this.element), this.table.element.style.display = "")
        ...
        this.manualBlock = !0, this.element = document.createElement("div"), this.element.classList.add("RCtable-print-fullscreen"), this.table.options.printHeader && (r.classList.add("RCtable-print-header"), i = "function" == typeof this.table.options.printHeader ? this.table.options.printHeader.call(this.table) : this.table.options.printHeader, "string" == typeof i ? r.innerHTML = i : r.appendChild(i), this.element.appendChild(r)), this.element.appendChild(c), this.table.options.printFooter && (l.classList.add("RCtable-print-footer"), n = "function" == typeof this.table.options.printFooter ? this.table.options.printFooter.call(this.table) : this.table.options.printFooter, "string" == typeof n ? l.innerHTML = n : l.appendChild(n), this.element.appendChild(l)), document.body.classList.add("RCtable-print-fullscreen-hide"), document.body.appendChild(this.element), this.table.options.printFormatter && this.table.options.printFormatter(this.element, c), window.print(), this.cleanup(), window.scrollTo(s, a), this.manualBlock = !1
    ...
    G.prototype.watchData = function(e) {
        ...
        if (!1 !== this.data)
            for (var e in this.origFuncs) Object.defineProperty(this.data, e, {
                enumerable: !0,
                configurable: !0,
                writable: !0,
        ...
        function t() {
            o.table.modules.dataTree.initializeRow(e), o.table.modules.dataTree.layoutRow(e), o.table.rowManager.refreshActiveData("tree", !1, !0)
        }
        var o = this,
        ...
        var t = e.getData();
        for (var o in t) Object.defineProperty(t, o, {
            value: t[o]
        })
    ...
    U.prototype.initializeColumn = function(e, t, o) {
        ...
        if ("header" === e && (n = "textarea" == t.definition.formatter || t.definition.variableHeight, t.modules.resize = {
            ...
            a.className = "RCtable-col-resize-handle";
            var r = document.createElement("div");
            r.className = "RCtable-col-resize-handle prev", a.addEventListener("click", function(e) {
                e.stopPropagation()
            });
            var l = function(e) {
            ...
            a.addEventListener("mousedown", l), a.addEventListener("touchstart", l, {
                passive: !0
            ...
            r.addEventListener("mousedown", c), r.addEventListener("touchstart", c, {
                passive: !0
    ...
    X.prototype.initializeRow = function(e) {
        var t = this,
            o = e.getElement(),
            i = document.createElement("div");
        i.className = "RCtable-row-resize-handle";
        var n = document.createElement("div");
        n.className = "RCtable-row-resize-handle prev", i.addEventListener("click", function(e) {
            e.stopPropagation()
        });
        var s = function(o) {
        ...
        n.addEventListener("mousedown", a), n.addEventListener("touchstart", a, {
            passive: !0
        ...
        function n(e) {
            document.body.removeEventListener("mouseup", i), document.body.removeEventListener("mousemove", i), o.removeEventListener("touchmove", i), o.removeEventListener("touchend", n), s.table.element.classList.remove("RCtable-block-select"), s.table.options.rowResized.call(this.table, t.getComponent())
        }
        var s = this;
        s.table.element.classList.add("RCtable-block-select"), e.stopPropagation(), s.startY = void 0 === e.screenY ? e.touches[0].screenY : e.screenY, s.startHeight = t.getHeight(), document.body.addEventListener("mousemove", i), document.body.addEventListener("mouseup", n), o.addEventListener("touchmove", i, {
            passive: !0
        }), o.addEventListener("touchend", n)
    ...
    q.prototype.initialize = function(e) {
        ...
        this.tableHeight = i.element.clientHeight, this.tableWidth = i.element.clientWidth, i.element.parentNode && (this.containerHeight = i.element.parentNode.clientHeight, this.containerWidth = i.element.parentNode.clientWidth), "undefined" != typeof ResizeObserver && "virtual" === i.rowManager.getRenderMode() ? (this.autoResize = !0, this.observer = new ResizeObserver(function(e) {
            if (!i.browserMobile || i.browserMobile && !i.modules.edit.currentCell) {
                ...
                o.tableHeight == t && o.tableWidth == n || (o.tableHeight = t, o.tableWidth = n, i.element.parentNode && (o.containerHeight = i.element.parentNode.clientHeight, o.containerWidth = i.element.parentNode.clientWidth), i.options.virtualDomHoz && i.vdomHoz.reinitialize(!0), i.redraw())
            }
            ...
            if (!i.browserMobile || i.browserMobile && !i.modules.edit.currentCell) {
                var t = Math.floor(e[0].contentRect.height),
                    n = Math.floor(e[0].contentRect.width);
                o.containerHeight == t && o.containerWidth == n || (o.containerHeight = t, o.containerWidth = n, o.tableHeight = i.element.clientHeight, o.tableWidth = i.element.clientWidth), i.options.virtualDomHoz && i.vdomHoz.reinitialize(!0), i.redraw()
            }
    ...
    Y.prototype.initialize = function() {
        ...
        var t;
        "calc" !== e.type && (t = document.createElement("div"), t.classList.add("RCtable-responsive-collapse"), e.modules.responsiveLayout = {
            element: t,
        ...
        return e.forEach(function(e) {
            ...
            n.appendChild(a), this.table.modules.localize.bind("columns|" + e.field, function(t) {
                a.innerText = t || e.title
            }), e.value instanceof Node ? (o = document.createElement("div"), o.appendChild(e.value), s.appendChild(o)) : s.innerHTML = e.value, i.appendChild(n), i.appendChild(s), t.appendChild(i)
    ...
    K.prototype.clearSelectionData = function(e) {
        ...
        e.modules.select = {
            selected: !1
        }, t.table.options.selectableCheck.call(this.table, e.getComponent()) ? (o.classList.add("RCtable-selectable"), o.classList.remove("RCtable-unselectable"), t.table.options.selectable && "highlight" != t.table.options.selectable && ("click" === t.table.options.selectableRangeMode ? o.addEventListener("click", function(o) {
            if (o.shiftKey) {
        ...
        })))) : (o.classList.add("RCtable-unselectable"), o.classList.remove("RCtable-selectable"))
    ...
    J.prototype.initializeColumn = function(e, t) {
        ...
        }, (void 0 === e.definition.headerSort ? !1 !== this.table.options.headerSort : !1 !== e.definition.headerSort) && (o = e.getElement(), o.classList.add("RCtable-sortable"), i = document.createElement("div"), i.classList.add("RCtable-col-sorter"), "object" == _typeof(this.table.options.headerSortElement) ? i.appendChild(this.table.options.headerSortElement) : i.innerHTML = this.table.options.headerSortElement, t.appendChild(i), e.modules.sort.element = i, o.addEventListener("click", function(t) {
            var o = "",
                i = [],
                s = !1;
            if (e.modules.sort) {
        ...
        var t, o = this.table.rowManager.activeRows[0],
            i = "string";
        ...
        number: function(e, t, o, i, n, s, a) {
            var r = a.alignEmptyValues,
                ...
                u = 0;
            if (e = String(e), t = String(t), c && (e = e.split(c).join(""), t = t.split(c).join("")), l && (e = e.split(l).join("."), t = t.split(l).join(".")), e = parseFloat(e), t = parseFloat(t), isNaN(e)) u = isNaN(t) ? 0 : -1;
            else {
    ...
    return $.prototype.initializeColumn = function(e) {
        ...
        }), n = !n.length || n, t.modules.validate || (t.modules.validate = {}), !0 === n ? (t.modules.validate.invalid = !1, t.getElement().classList.remove("RCtable-validation-fail"), s > -1 && this.invalidCells.splice(s, 1)) : (t.modules.validate.invalid = !0, "manual" !== this.table.options.validationMode && t.getElement().classList.add("RCtable-validation-fail"), -1 == s && this.invalidCells.push(t)), n
        ...
        var t;
        e.modules.validate && e.modules.validate.invalid && (e.getElement().classList.remove("RCtable-validation-fail"), e.modules.validate.invalid = !1, (t = this.invalidCells.indexOf(e)) > -1 && this.invalidCells.splice(t, 1))

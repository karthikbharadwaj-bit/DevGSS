({
    ...
    addproduct : function(component, event, helper) { 
        ...
        if(selectedProductList[MainCategoryIndex].subCategoryList[subCategoryIndex].productList[productIndex].isSelected) {
            ...
            selectedProductList[MainCategoryIndex].subCategoryList[subCategoryIndex].productList[productIndex].quantity = null;
            selectedProductList[MainCategoryIndex].subCategoryList[subCategoryIndex].productList[productIndex].discount = null;
        }
        else {
